...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/shared_set_error.proto',
...
SharedSetErrorEnum = _reflection.GeneratedProtocolMessageType('SharedSetErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.shared_set_error_pb2'
