...
_FUNCTIONERRORENUM_FUNCTIONERROR = _descriptor.EnumDescriptor(
  name='FunctionError',
  full_name='google.ads.googleads.v2.errors.FunctionErrorEnum.FunctionError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FUNCTIONERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.FunctionErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
FunctionErrorEnum = _reflection.GeneratedProtocolMessageType('FunctionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.function_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.FunctionErrorEnum)
  })
