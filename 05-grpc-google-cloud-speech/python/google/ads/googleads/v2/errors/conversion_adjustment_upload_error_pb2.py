...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/conversion_adjustment_upload_error.proto',
...
ConversionAdjustmentUploadErrorEnum = _reflection.GeneratedProtocolMessageType('ConversionAdjustmentUploadErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.conversion_adjustment_upload_error_pb2'
