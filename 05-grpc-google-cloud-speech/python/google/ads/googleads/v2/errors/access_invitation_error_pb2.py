...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/access_invitation_error.proto',
...
AccessInvitationErrorEnum = _reflection.GeneratedProtocolMessageType('AccessInvitationErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.access_invitation_error_pb2'
