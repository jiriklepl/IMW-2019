...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/criterion_error.proto',
...
CriterionErrorEnum = _reflection.GeneratedProtocolMessageType('CriterionErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.criterion_error_pb2'
