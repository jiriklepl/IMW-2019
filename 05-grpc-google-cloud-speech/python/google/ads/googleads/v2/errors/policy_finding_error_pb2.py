...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/policy_finding_error.proto',
...
PolicyFindingErrorEnum = _reflection.GeneratedProtocolMessageType('PolicyFindingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.policy_finding_error_pb2'
