...
_BIDDINGERRORENUM_BIDDINGERROR = _descriptor.EnumDescriptor(
  name='BiddingError',
  full_name='google.ads.googleads.v2.errors.BiddingErrorEnum.BiddingError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BIDDINGERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.BiddingErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
BiddingErrorEnum = _reflection.GeneratedProtocolMessageType('BiddingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.bidding_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.BiddingErrorEnum)
  })
