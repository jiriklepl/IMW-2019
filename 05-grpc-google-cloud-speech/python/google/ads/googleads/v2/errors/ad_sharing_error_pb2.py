...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/ad_sharing_error.proto',
...
AdSharingErrorEnum = _reflection.GeneratedProtocolMessageType('AdSharingErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.ad_sharing_error_pb2'
