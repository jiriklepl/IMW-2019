...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/request_error.proto',
...
RequestErrorEnum = _reflection.GeneratedProtocolMessageType('RequestErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.request_error_pb2'
