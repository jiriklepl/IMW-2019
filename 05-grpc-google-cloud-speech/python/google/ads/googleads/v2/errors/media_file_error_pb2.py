...
_MEDIAFILEERRORENUM_MEDIAFILEERROR = _descriptor.EnumDescriptor(
  name='MediaFileError',
  full_name='google.ads.googleads.v2.errors.MediaFileErrorEnum.MediaFileError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MEDIAFILEERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.MediaFileErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
MediaFileErrorEnum = _reflection.GeneratedProtocolMessageType('MediaFileErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.media_file_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.MediaFileErrorEnum)
  })
