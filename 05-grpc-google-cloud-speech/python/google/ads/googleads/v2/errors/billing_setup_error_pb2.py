...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/billing_setup_error.proto',
...
_BILLINGSETUPERRORENUM_BILLINGSETUPERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.errors.BillingSetupErrorEnum.BillingSetupError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BILLINGSETUPERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.BillingSetupErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
BillingSetupErrorEnum = _reflection.GeneratedProtocolMessageType('BillingSetupErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.billing_setup_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.BillingSetupErrorEnum)
  })
