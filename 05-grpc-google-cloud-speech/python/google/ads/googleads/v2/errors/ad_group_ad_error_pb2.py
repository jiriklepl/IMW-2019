...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/ad_group_ad_error.proto',
...
AdGroupAdErrorEnum = _reflection.GeneratedProtocolMessageType('AdGroupAdErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.ad_group_ad_error_pb2'
