...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/authorization_error.proto',
...
_AUTHORIZATIONERRORENUM_AUTHORIZATIONERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.errors.AuthorizationErrorEnum.AuthorizationError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_AUTHORIZATIONERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.AuthorizationErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
AuthorizationErrorEnum = _reflection.GeneratedProtocolMessageType('AuthorizationErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.authorization_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.AuthorizationErrorEnum)
  })
