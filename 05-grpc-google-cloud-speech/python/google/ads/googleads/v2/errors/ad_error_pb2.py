...
_ADERRORENUM_ADERROR = _descriptor.EnumDescriptor(
  name='AdError',
  full_name='google.ads.googleads.v2.errors.AdErrorEnum.AdError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ADERRORENUM = _descriptor.Descriptor(
  name='AdErrorEnum',
  full_name='google.ads.googleads.v2.errors.AdErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
AdErrorEnum = _reflection.GeneratedProtocolMessageType('AdErrorEnum', (_message.Message,), {
  'DESCRIPTOR' : _ADERRORENUM,
  '__module__' : 'google.ads.googleads.v2.errors.ad_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.AdErrorEnum)
  })
