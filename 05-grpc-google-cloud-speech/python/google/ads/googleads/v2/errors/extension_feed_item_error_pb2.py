...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/extension_feed_item_error.proto',
...
ExtensionFeedItemErrorEnum = _reflection.GeneratedProtocolMessageType('ExtensionFeedItemErrorEnum', (_message.Message,), {
  'DESCRIPTOR' : _EXTENSIONFEEDITEMERRORENUM,
  '__module__' : 'google.ads.googleads.v2.errors.extension_feed_item_error_pb2'
