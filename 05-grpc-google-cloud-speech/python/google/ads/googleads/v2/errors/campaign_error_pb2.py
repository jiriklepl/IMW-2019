...
_CAMPAIGNERRORENUM_CAMPAIGNERROR = _descriptor.EnumDescriptor(
  name='CampaignError',
  full_name='google.ads.googleads.v2.errors.CampaignErrorEnum.CampaignError',
  filename=None,
  file=DESCRIPTOR,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INSUFFICIENT_APP_INSTALLS_COUNT', index=41, number=44,
      serialized_options=None,
      type=None),
  ],
...
_CAMPAIGNERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.CampaignErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
CampaignErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.campaign_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.CampaignErrorEnum)
  })
