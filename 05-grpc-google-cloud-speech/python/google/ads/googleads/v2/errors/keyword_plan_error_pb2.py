...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/errors/keyword_plan_error.proto',
...
KeywordPlanErrorEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.keyword_plan_error_pb2'
