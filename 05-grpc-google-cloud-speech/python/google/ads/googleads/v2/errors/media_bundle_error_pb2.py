...
_MEDIABUNDLEERRORENUM_MEDIABUNDLEERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.errors.MediaBundleErrorEnum.MediaBundleError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_MEDIABUNDLEERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.MediaBundleErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
MediaBundleErrorEnum = _reflection.GeneratedProtocolMessageType('MediaBundleErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.media_bundle_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.MediaBundleErrorEnum)
  })
