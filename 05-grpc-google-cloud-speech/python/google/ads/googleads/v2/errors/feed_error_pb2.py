...
_FEEDERRORENUM_FEEDERROR = _descriptor.EnumDescriptor(
  name='FeedError',
  full_name='google.ads.googleads.v2.errors.FeedErrorEnum.FeedError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_FEEDERRORENUM = _descriptor.Descriptor(
  name='FeedErrorEnum',
  full_name='google.ads.googleads.v2.errors.FeedErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
FeedErrorEnum = _reflection.GeneratedProtocolMessageType('FeedErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.feed_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.FeedErrorEnum)
  })
