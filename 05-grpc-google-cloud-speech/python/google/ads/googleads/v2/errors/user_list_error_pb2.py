...
_USERLISTERRORENUM_USERLISTERROR = _descriptor.EnumDescriptor(
  name='UserListError',
  full_name='google.ads.googleads.v2.errors.UserListErrorEnum.UserListError',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_USERLISTERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.errors.UserListErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
UserListErrorEnum = _reflection.GeneratedProtocolMessageType('UserListErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.errors.user_list_error_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.errors.UserListErrorEnum)
  })
