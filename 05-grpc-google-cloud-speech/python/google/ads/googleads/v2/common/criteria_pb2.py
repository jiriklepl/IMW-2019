...
from google.ads.googleads.v2.enums import age_range_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_age__range__type__pb2
from google.ads.googleads.v2.enums import app_payment_model_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_app__payment__model__type__pb2
from google.ads.googleads.v2.enums import content_label_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_content__label__type__pb2
...
from google.ads.googleads.v2.enums import gender_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_gender__type__pb2
...
from google.ads.googleads.v2.enums import income_range_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_income__range__type__pb2
from google.ads.googleads.v2.enums import interaction_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_interaction__type__pb2
from google.ads.googleads.v2.enums import keyword_match_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_keyword__match__type__pb2
from google.ads.googleads.v2.enums import listing_custom_attribute_index_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_listing__custom__attribute__index__pb2
from google.ads.googleads.v2.enums import listing_group_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_listing__group__type__pb2
from google.ads.googleads.v2.enums import location_group_radius_units_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_location__group__radius__units__pb2
from google.ads.googleads.v2.enums import minute_of_hour_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_minute__of__hour__pb2
from google.ads.googleads.v2.enums import parental_status_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_parental__status__type__pb2
from google.ads.googleads.v2.enums import preferred_content_type_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_preferred__content__type__pb2
from google.ads.googleads.v2.enums import product_bidding_category_level_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__bidding__category__level__pb2
...
from google.ads.googleads.v2.enums import product_type_level_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__type__level__pb2
from google.ads.googleads.v2.enums import proximity_radius_units_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_proximity__radius__units__pb2
from google.ads.googleads.v2.enums import webpage_condition_operand_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_webpage__condition__operand__pb2
from google.ads.googleads.v2.enums import webpage_condition_operator_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_webpage__condition__operator__pb2
from google.protobuf import wrappers_pb2 as google_dot_protobuf_dot_wrappers__pb2
from google.api import annotations_pb2 as google_dot_api_dot_annotations__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/common/criteria.proto',
...
_KEYWORDINFO.fields_by_name['match_type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_keyword__match__type__pb2._KEYWORDMATCHTYPEENUM_KEYWORDMATCHTYPE
...
_DEVICEINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_device__pb2._DEVICEENUM_DEVICE
_PREFERREDCONTENTINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_preferred__content__type__pb2._PREFERREDCONTENTTYPEENUM_PREFERREDCONTENTTYPE
_LISTINGGROUPINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_listing__group__type__pb2._LISTINGGROUPTYPEENUM_LISTINGGROUPTYPE
...
_LISTINGCUSTOMATTRIBUTEINFO.fields_by_name['index'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_listing__custom__attribute__index__pb2._LISTINGCUSTOMATTRIBUTEINDEXENUM_LISTINGCUSTOMATTRIBUTEINDEX
...
_PRODUCTBIDDINGCATEGORYINFO.fields_by_name['level'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__bidding__category__level__pb2._PRODUCTBIDDINGCATEGORYLEVELENUM_PRODUCTBIDDINGCATEGORYLEVEL
_PRODUCTCHANNELINFO.fields_by_name['channel'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__channel__pb2._PRODUCTCHANNELENUM_PRODUCTCHANNEL
_PRODUCTCHANNELEXCLUSIVITYINFO.fields_by_name['channel_exclusivity'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__channel__exclusivity__pb2._PRODUCTCHANNELEXCLUSIVITYENUM_PRODUCTCHANNELEXCLUSIVITY
_PRODUCTCONDITIONINFO.fields_by_name['condition'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__condition__pb2._PRODUCTCONDITIONENUM_PRODUCTCONDITION
...
_PRODUCTTYPEINFO.fields_by_name['level'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_product__type__level__pb2._PRODUCTTYPELEVELENUM_PRODUCTTYPELEVEL
_HOTELDATESELECTIONTYPEINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_hotel__date__selection__type__pb2._HOTELDATESELECTIONTYPEENUM_HOTELDATESELECTIONTYPE
...
_HOTELCHECKINDAYINFO.fields_by_name['day_of_week'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_day__of__week__pb2._DAYOFWEEKENUM_DAYOFWEEK
_INTERACTIONTYPEINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_interaction__type__pb2._INTERACTIONTYPEENUM_INTERACTIONTYPE
_ADSCHEDULEINFO.fields_by_name['start_minute'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_minute__of__hour__pb2._MINUTEOFHOURENUM_MINUTEOFHOUR
_ADSCHEDULEINFO.fields_by_name['end_minute'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_minute__of__hour__pb2._MINUTEOFHOURENUM_MINUTEOFHOUR
...
_ADSCHEDULEINFO.fields_by_name['day_of_week'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_day__of__week__pb2._DAYOFWEEKENUM_DAYOFWEEK
_AGERANGEINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_age__range__type__pb2._AGERANGETYPEENUM_AGERANGETYPE
_GENDERINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_gender__type__pb2._GENDERTYPEENUM_GENDERTYPE
_INCOMERANGEINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_income__range__type__pb2._INCOMERANGETYPEENUM_INCOMERANGETYPE
_PARENTALSTATUSINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_parental__status__type__pb2._PARENTALSTATUSTYPEENUM_PARENTALSTATUSTYPE
...
_PROXIMITYINFO.fields_by_name['radius_units'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_proximity__radius__units__pb2._PROXIMITYRADIUSUNITSENUM_PROXIMITYRADIUSUNITS
...
_CONTENTLABELINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_content__label__type__pb2._CONTENTLABELTYPEENUM_CONTENTLABELTYPE
...
_WEBPAGECONDITIONINFO.fields_by_name['operand'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_webpage__condition__operand__pb2._WEBPAGECONDITIONOPERANDENUM_WEBPAGECONDITIONOPERAND
_WEBPAGECONDITIONINFO.fields_by_name['operator'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_webpage__condition__operator__pb2._WEBPAGECONDITIONOPERATORENUM_WEBPAGECONDITIONOPERATOR
...
_APPPAYMENTMODELINFO.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_app__payment__model__type__pb2._APPPAYMENTMODELTYPEENUM_APPPAYMENTMODELTYPE
...
_LOCATIONGROUPINFO.fields_by_name['radius_units'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_location__group__radius__units__pb2._LOCATIONGROUPRADIUSUNITSENUM_LOCATIONGROUPRADIUSUNITS
...
KeywordInfo = _reflection.GeneratedProtocolMessageType('KeywordInfo', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.common.criteria_pb2'
