...
_DYNAMICSEARCHADSSEARCHTERMVIEW = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='search_term', full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView.search_term', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='headline', full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView.headline', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='landing_page', full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView.landing_page', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_url', full_name='google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView.page_url', index=4,
...
DynamicSearchAdsSearchTermView = _reflection.GeneratedProtocolMessageType('DynamicSearchAdsSearchTermView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.resources.dynamic_search_ads_search_term_view_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.resources.DynamicSearchAdsSearchTermView)
  })
