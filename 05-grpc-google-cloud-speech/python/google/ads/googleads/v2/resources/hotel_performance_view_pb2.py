...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/resources/hotel_performance_view.proto',
...
HotelPerformanceView = _reflection.GeneratedProtocolMessageType('HotelPerformanceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.resources.hotel_performance_view_pb2'
