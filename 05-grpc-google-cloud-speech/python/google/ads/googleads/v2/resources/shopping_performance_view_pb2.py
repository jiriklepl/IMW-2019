...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/resources/shopping_performance_view.proto',
...
ShoppingPerformanceView = _reflection.GeneratedProtocolMessageType('ShoppingPerformanceView', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.resources.shopping_performance_view_pb2'
