...
_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASONENUM_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASON = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CUSTOMERPAYPERCONVERSIONELIGIBILITYFAILUREREASONENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.enums.CustomerPayPerConversionEligibilityFailureReasonEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
CustomerPayPerConversionEligibilityFailureReasonEnum = _reflection.GeneratedProtocolMessageType('CustomerPayPerConversionEligibilityFailureReasonEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.enums.customer_pay_per_conversion_eligibility_failure_reason_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.enums.CustomerPayPerConversionEligibilityFailureReasonEnum)
  })
