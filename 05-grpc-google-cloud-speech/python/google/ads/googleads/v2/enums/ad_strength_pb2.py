...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/enums/ad_strength.proto',
...
AdStrengthEnum = _reflection.GeneratedProtocolMessageType('AdStrengthEnum', (_message.Message,), {
  'DESCRIPTOR' : _ADSTRENGTHENUM,
  '__module__' : 'google.ads.googleads.v2.enums.ad_strength_pb2'
