...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/enums/distance_bucket.proto',
...
DistanceBucketEnum = _reflection.GeneratedProtocolMessageType('DistanceBucketEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.enums.distance_bucket_pb2'
