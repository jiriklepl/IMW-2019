...
_HOTELPLACEHOLDERFIELDENUM_HOTELPLACEHOLDERFIELD = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.enums.HotelPlaceholderFieldEnum.HotelPlaceholderField',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HOTELPLACEHOLDERFIELDENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.enums.HotelPlaceholderFieldEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
HotelPlaceholderFieldEnum = _reflection.GeneratedProtocolMessageType('HotelPlaceholderFieldEnum', (_message.Message,), {
  'DESCRIPTOR' : _HOTELPLACEHOLDERFIELDENUM,
  '__module__' : 'google.ads.googleads.v2.enums.hotel_placeholder_field_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.enums.HotelPlaceholderFieldEnum)
  })
