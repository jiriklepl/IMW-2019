...
_POLICYTOPICEVIDENCEDESTINATIONMISMATCHURLTYPEENUM_POLICYTOPICEVIDENCEDESTINATIONMISMATCHURLTYPE = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v2.enums.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
PolicyTopicEvidenceDestinationMismatchUrlTypeEnum = _reflection.GeneratedProtocolMessageType('PolicyTopicEvidenceDestinationMismatchUrlTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.enums.policy_topic_evidence_destination_mismatch_url_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.enums.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum)
  })
