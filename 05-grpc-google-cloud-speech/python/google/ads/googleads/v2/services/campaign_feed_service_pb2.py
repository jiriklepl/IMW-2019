...
_GETCAMPAIGNFEEDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.GetCampaignFeedRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.GetCampaignFeedRequest.resource_name', index=0,
...
_MUTATECAMPAIGNFEEDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCampaignFeedsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsRequest.validate_only', index=3,
...
_CAMPAIGNFEEDOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.CampaignFeedOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v2.services.CampaignFeedOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v2.services.CampaignFeedOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v2.services.CampaignFeedOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v2.services.CampaignFeedOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v2.services.CampaignFeedOperation.operation',
...
_MUTATECAMPAIGNFEEDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCampaignFeedsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v2.services.MutateCampaignFeedsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNFEEDRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCampaignFeedResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.MutateCampaignFeedResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CAMPAIGNFEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_campaign__feed__pb2._CAMPAIGNFEED
_CAMPAIGNFEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_campaign__feed__pb2._CAMPAIGNFEED
...
GetCampaignFeedRequest = _reflection.GeneratedProtocolMessageType('GetCampaignFeedRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.campaign_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.GetCampaignFeedRequest)
  })
...
MutateCampaignFeedsRequest = _reflection.GeneratedProtocolMessageType('MutateCampaignFeedsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.campaign_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCampaignFeedsRequest)
  })
...
CampaignFeedOperation = _reflection.GeneratedProtocolMessageType('CampaignFeedOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.campaign_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.CampaignFeedOperation)
  })
...
MutateCampaignFeedsResponse = _reflection.GeneratedProtocolMessageType('MutateCampaignFeedsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.campaign_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCampaignFeedsResponse)
  })
...
MutateCampaignFeedResult = _reflection.GeneratedProtocolMessageType('MutateCampaignFeedResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.campaign_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCampaignFeedResult)
  })
...
_CAMPAIGNFEEDSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v2.services.CampaignFeedService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v2.services.CampaignFeedService.GetCampaignFeed',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNFEEDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_campaign__feed__pb2._CAMPAIGNFEED,
    serialized_options=b'\202\323\344\223\0021\022//v2/{resource_name=customers/*/campaignFeeds/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateCampaignFeeds',
    full_name='google.ads.googleads.v2.services.CampaignFeedService.MutateCampaignFeeds',
    index=1,
    containing_service=None,
    input_type=_MUTATECAMPAIGNFEEDSREQUEST,
    output_type=_MUTATECAMPAIGNFEEDSRESPONSE,
    serialized_options=b'\202\323\344\223\0027\"2/v2/customers/{customer_id=*}/campaignFeeds:mutate:\001*',
  ),
])
