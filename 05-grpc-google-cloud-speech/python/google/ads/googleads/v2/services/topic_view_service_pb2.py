...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/topic_view_service.proto',
...
GetTopicViewRequest = _reflection.GeneratedProtocolMessageType('GetTopicViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.topic_view_service_pb2'
...
_TOPICVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_topic__view__pb2._TOPICVIEW,
    serialized_options=b'\202\323\344\223\002.\022,/v2/{resource_name=customers/*/topicViews/*}',
  ),
])
