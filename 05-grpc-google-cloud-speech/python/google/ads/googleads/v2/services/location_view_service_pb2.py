...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/location_view_service.proto',
...
GetLocationViewRequest = _reflection.GeneratedProtocolMessageType('GetLocationViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.location_view_service_pb2'
...
_LOCATIONVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_location__view__pb2._LOCATIONVIEW,
    serialized_options=b'\202\323\344\223\0021\022//v2/{resource_name=customers/*/locationViews/*}',
  ),
])
