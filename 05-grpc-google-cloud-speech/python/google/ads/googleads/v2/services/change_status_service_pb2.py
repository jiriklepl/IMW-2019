...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/change_status_service.proto',
...
GetChangeStatusRequest = _reflection.GeneratedProtocolMessageType('GetChangeStatusRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.change_status_service_pb2'
...
_CHANGESTATUSSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_change__status__pb2._CHANGESTATUS,
    serialized_options=b'\202\323\344\223\0020\022./v2/{resource_name=customers/*/changeStatus/*}',
  ),
])
