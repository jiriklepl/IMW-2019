...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/media_file_service.proto',
...
_MEDIAFILEOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_media__file__pb2._MEDIAFILE
...
GetMediaFileRequest = _reflection.GeneratedProtocolMessageType('GetMediaFileRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.media_file_service_pb2'
...
_MEDIAFILESERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_media__file__pb2._MEDIAFILE,
    serialized_options=b'\202\323\344\223\002.\022,/v2/{resource_name=customers/*/mediaFiles/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0024\"//v2/customers/{customer_id=*}/mediaFiles:mutate:\001*',
  ),
])
