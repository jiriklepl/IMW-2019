...
from google.ads.googleads.v2.services import ad_group_ad_asset_view_service_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_services_dot_ad__group__ad__asset__view__service__pb2
...
class AdGroupAdAssetViewServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetAdGroupAdAssetView = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_ad__group__ad__asset__view__service__pb2.GetAdGroupAdAssetViewRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_ad__group__ad__asset__view__pb2.AdGroupAdAssetView.FromString,
        )
...
def add_AdGroupAdAssetViewServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetAdGroupAdAssetView': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_ad__group__ad__asset__view__service__pb2.GetAdGroupAdAssetViewRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_ad__group__ad__asset__view__pb2.AdGroupAdAssetView.SerializeToString,
      ),
  }
