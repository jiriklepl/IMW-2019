...
_GETCUSTOMERNEGATIVECRITERIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.GetCustomerNegativeCriterionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.GetCustomerNegativeCriterionRequest.resource_name', index=0,
...
_MUTATECUSTOMERNEGATIVECRITERIAREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest.validate_only', index=3,
...
_CUSTOMERNEGATIVECRITERIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionOperation.create', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionOperation.operation',
...
_MUTATECUSTOMERNEGATIVECRITERIARESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMERNEGATIVECRITERIARESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CUSTOMERNEGATIVECRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
GetCustomerNegativeCriterionRequest = _reflection.GeneratedProtocolMessageType('GetCustomerNegativeCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_negative_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.GetCustomerNegativeCriterionRequest)
  })
...
MutateCustomerNegativeCriteriaRequest = _reflection.GeneratedProtocolMessageType('MutateCustomerNegativeCriteriaRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_negative_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaRequest)
  })
...
CustomerNegativeCriterionOperation = _reflection.GeneratedProtocolMessageType('CustomerNegativeCriterionOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_negative_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.CustomerNegativeCriterionOperation)
  })
...
MutateCustomerNegativeCriteriaResponse = _reflection.GeneratedProtocolMessageType('MutateCustomerNegativeCriteriaResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_negative_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResponse)
  })
...
MutateCustomerNegativeCriteriaResult = _reflection.GeneratedProtocolMessageType('MutateCustomerNegativeCriteriaResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_negative_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateCustomerNegativeCriteriaResult)
  })
...
_CUSTOMERNEGATIVECRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionService.GetCustomerNegativeCriterion',
    index=0,
    containing_service=None,
    input_type=_GETCUSTOMERNEGATIVECRITERIONREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION,
    serialized_options=b'\202\323\344\223\002<\022:/v2/{resource_name=customers/*/customerNegativeCriteria/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomerNegativeCriteria',
    full_name='google.ads.googleads.v2.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria',
    index=1,
    containing_service=None,
    input_type=_MUTATECUSTOMERNEGATIVECRITERIAREQUEST,
    output_type=_MUTATECUSTOMERNEGATIVECRITERIARESPONSE,
    serialized_options=b'\202\323\344\223\002B\"=/v2/customers/{customer_id=*}/customerNegativeCriteria:mutate:\001*',
  ),
])
