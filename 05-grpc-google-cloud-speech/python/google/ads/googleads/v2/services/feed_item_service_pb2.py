...
_GETFEEDITEMREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.GetFeedItemRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.GetFeedItemRequest.resource_name', index=0,
...
_MUTATEFEEDITEMSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateFeedItemsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v2.services.MutateFeedItemsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v2.services.MutateFeedItemsRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v2.services.MutateFeedItemsRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v2.services.MutateFeedItemsRequest.validate_only', index=3,
...
_FEEDITEMOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.FeedItemOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v2.services.FeedItemOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v2.services.FeedItemOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v2.services.FeedItemOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v2.services.FeedItemOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v2.services.FeedItemOperation.operation',
...
_MUTATEFEEDITEMSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateFeedItemsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v2.services.MutateFeedItemsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v2.services.MutateFeedItemsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEFEEDITEMRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateFeedItemResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.MutateFeedItemResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEEDITEMOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_feed__item__pb2._FEEDITEM
_FEEDITEMOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_feed__item__pb2._FEEDITEM
...
GetFeedItemRequest = _reflection.GeneratedProtocolMessageType('GetFeedItemRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.feed_item_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.GetFeedItemRequest)
  })
...
MutateFeedItemsRequest = _reflection.GeneratedProtocolMessageType('MutateFeedItemsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.feed_item_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateFeedItemsRequest)
  })
...
FeedItemOperation = _reflection.GeneratedProtocolMessageType('FeedItemOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.feed_item_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.FeedItemOperation)
  })
...
MutateFeedItemsResponse = _reflection.GeneratedProtocolMessageType('MutateFeedItemsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.feed_item_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateFeedItemsResponse)
  })
...
MutateFeedItemResult = _reflection.GeneratedProtocolMessageType('MutateFeedItemResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.feed_item_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateFeedItemResult)
  })
...
_FEEDITEMSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v2.services.FeedItemService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetFeedItem',
    full_name='google.ads.googleads.v2.services.FeedItemService.GetFeedItem',
    index=0,
    containing_service=None,
    input_type=_GETFEEDITEMREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_feed__item__pb2._FEEDITEM,
    serialized_options=b'\202\323\344\223\002-\022+/v2/{resource_name=customers/*/feedItems/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateFeedItems',
    full_name='google.ads.googleads.v2.services.FeedItemService.MutateFeedItems',
    index=1,
    containing_service=None,
    input_type=_MUTATEFEEDITEMSREQUEST,
    output_type=_MUTATEFEEDITEMSRESPONSE,
    serialized_options=b'\202\323\344\223\0023\"./v2/customers/{customer_id=*}/feedItems:mutate:\001*',
  ),
])
