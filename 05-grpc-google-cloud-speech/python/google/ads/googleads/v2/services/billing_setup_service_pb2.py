...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/billing_setup_service.proto',
...
_BILLINGSETUPOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_billing__setup__pb2._BILLINGSETUP
...
GetBillingSetupRequest = _reflection.GeneratedProtocolMessageType('GetBillingSetupRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.billing_setup_service_pb2'
...
_BILLINGSETUPSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_billing__setup__pb2._BILLINGSETUP,
    serialized_options=b'\202\323\344\223\0021\022//v2/{resource_name=customers/*/billingSetups/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0027\"2/v2/customers/{customer_id=*}/billingSetups:mutate:\001*',
  ),
])
