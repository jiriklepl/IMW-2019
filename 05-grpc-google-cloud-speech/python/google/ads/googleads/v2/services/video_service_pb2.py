...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/video_service.proto',
...
GetVideoRequest = _reflection.GeneratedProtocolMessageType('GetVideoRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.video_service_pb2'
...
_VIDEOSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_video__pb2._VIDEO,
    serialized_options=b'\202\323\344\223\002*\022(/v2/{resource_name=customers/*/videos/*}',
  ),
])
