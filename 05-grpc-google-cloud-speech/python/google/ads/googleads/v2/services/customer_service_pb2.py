...
from google.ads.googleads.v2.enums import access_role_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_access__role__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/customer_service.proto',
...
_CREATECUSTOMERCLIENTREQUEST.fields_by_name['customer_client'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_customer__pb2._CUSTOMER
...
_CREATECUSTOMERCLIENTREQUEST.fields_by_name['access_role'].enum_type = google_dot_ads_dot_googleads_dot_v2_dot_enums_dot_access__role__pb2._ACCESSROLEENUM_ACCESSROLE
_CUSTOMEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_customer__pb2._CUSTOMER
...
GetCustomerRequest = _reflection.GeneratedProtocolMessageType('GetCustomerRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.customer_service_pb2'
...
_CUSTOMERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_customer__pb2._CUSTOMER,
    serialized_options=b'\202\323\344\223\002!\022\037/v2/{resource_name=customers/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomer',
    ...
    serialized_options=b'\202\323\344\223\002)\"$/v2/customers/{customer_id=*}:mutate:\001*',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\'\022%/v2/customers:listAccessibleCustomers',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0027\"2/v2/customers/{customer_id=*}:createCustomerClient:\001*',
  ),
])
