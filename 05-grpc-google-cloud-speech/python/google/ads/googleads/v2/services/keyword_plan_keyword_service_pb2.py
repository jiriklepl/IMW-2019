...
_GETKEYWORDPLANKEYWORDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.GetKeywordPlanKeywordRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.GetKeywordPlanKeywordRequest.resource_name', index=0,
...
_MUTATEKEYWORDPLANKEYWORDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest.validate_only', index=3,
...
_KEYWORDPLANKEYWORDOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v2.services.KeywordPlanKeywordOperation.operation',
...
_MUTATEKEYWORDPLANKEYWORDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEKEYWORDPLANKEYWORDRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v2.services.MutateKeywordPlanKeywordResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANKEYWORDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD
_KEYWORDPLANKEYWORDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD
...
GetKeywordPlanKeywordRequest = _reflection.GeneratedProtocolMessageType('GetKeywordPlanKeywordRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.keyword_plan_keyword_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.GetKeywordPlanKeywordRequest)
  })
...
MutateKeywordPlanKeywordsRequest = _reflection.GeneratedProtocolMessageType('MutateKeywordPlanKeywordsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.keyword_plan_keyword_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateKeywordPlanKeywordsRequest)
  })
...
KeywordPlanKeywordOperation = _reflection.GeneratedProtocolMessageType('KeywordPlanKeywordOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.keyword_plan_keyword_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.KeywordPlanKeywordOperation)
  })
...
MutateKeywordPlanKeywordsResponse = _reflection.GeneratedProtocolMessageType('MutateKeywordPlanKeywordsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.keyword_plan_keyword_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateKeywordPlanKeywordsResponse)
  })
...
MutateKeywordPlanKeywordResult = _reflection.GeneratedProtocolMessageType('MutateKeywordPlanKeywordResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v2.services.keyword_plan_keyword_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v2.services.MutateKeywordPlanKeywordResult)
  })
...
_KEYWORDPLANKEYWORDSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v2.services.KeywordPlanKeywordService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v2.services.KeywordPlanKeywordService.GetKeywordPlanKeyword',
    index=0,
    containing_service=None,
    input_type=_GETKEYWORDPLANKEYWORDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_keyword__plan__keyword__pb2._KEYWORDPLANKEYWORD,
    serialized_options=b'\202\323\344\223\0027\0225/v2/{resource_name=customers/*/keywordPlanKeywords/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateKeywordPlanKeywords',
    full_name='google.ads.googleads.v2.services.KeywordPlanKeywordService.MutateKeywordPlanKeywords',
    index=1,
    containing_service=None,
    input_type=_MUTATEKEYWORDPLANKEYWORDSREQUEST,
    output_type=_MUTATEKEYWORDPLANKEYWORDSRESPONSE,
    serialized_options=b'\202\323\344\223\002=\"8/v2/customers/{customer_id=*}/keywordPlanKeywords:mutate:\001*',
  ),
])
