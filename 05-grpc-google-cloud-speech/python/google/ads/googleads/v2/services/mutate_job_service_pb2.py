...
from google.ads.googleads.v2.services import google_ads_service_pb2 as google_dot_ads_dot_googleads_dot_v2_dot_services_dot_google__ads__service__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v2/services/mutate_job_service.proto',
...
_ADDMUTATEJOBOPERATIONSREQUEST.fields_by_name['mutate_operations'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_services_dot_google__ads__service__pb2._MUTATEOPERATION
_LISTMUTATEJOBRESULTSRESPONSE.fields_by_name['results'].message_type = _MUTATEJOBRESULT
_MUTATEJOBRESULT.fields_by_name['mutate_operation_response'].message_type = google_dot_ads_dot_googleads_dot_v2_dot_services_dot_google__ads__service__pb2._MUTATEOPERATIONRESPONSE
...
CreateMutateJobRequest = _reflection.GeneratedProtocolMessageType('CreateMutateJobRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEMUTATEJOBREQUEST,
  '__module__' : 'google.ads.googleads.v2.services.mutate_job_service_pb2'
...
CreateMutateJobResponse = _reflection.GeneratedProtocolMessageType('CreateMutateJobResponse', (_message.Message,), {
...
GetMutateJobRequest = _reflection.GeneratedProtocolMessageType('GetMutateJobRequest', (_message.Message,), {
...
RunMutateJobRequest = _reflection.GeneratedProtocolMessageType('RunMutateJobRequest', (_message.Message,), {
...
AddMutateJobOperationsRequest = _reflection.GeneratedProtocolMessageType('AddMutateJobOperationsRequest', (_message.Message,), {
...
AddMutateJobOperationsResponse = _reflection.GeneratedProtocolMessageType('AddMutateJobOperationsResponse', (_message.Message,), {
...
ListMutateJobResultsRequest = _reflection.GeneratedProtocolMessageType('ListMutateJobResultsRequest', (_message.Message,), {
...
ListMutateJobResultsResponse = _reflection.GeneratedProtocolMessageType('ListMutateJobResultsResponse', (_message.Message,), {
...
MutateJobResult = _reflection.GeneratedProtocolMessageType('MutateJobResult', (_message.Message,), {
...
_MUTATEJOBSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0024\"//v2/customers/{customer_id=*}/mutateJobs:create:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='GetMutateJob',
    ...
    output_type=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_mutate__job__pb2._MUTATEJOB,
    serialized_options=b'\202\323\344\223\002.\022,/v2/{resource_name=customers/*/mutateJobs/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002:\0228/v2/{resource_name=customers/*/mutateJobs/*}:listResults',
  ),
  _descriptor.MethodDescriptor(
    name='RunMutateJob',
    ...
    serialized_options=b'\202\323\344\223\0025\"0/v2/{resource_name=customers/*/mutateJobs/*}:run:\001*\312AV\n\025google.protobuf.Empty\022=google.ads.googleads.v2.resources.MutateJob.MutateJobMetadata',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002?\":/v2/{resource_name=customers/*/mutateJobs/*}:addOperations:\001*',
  ),
])
