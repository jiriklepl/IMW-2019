...
class CampaignExperimentServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetCampaignExperiment = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GetCampaignExperimentRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_campaign__experiment__pb2.CampaignExperiment.FromString,
        )
    self.CreateCampaignExperiment = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.CreateCampaignExperimentRequest.SerializeToString,
    ...
    self.MutateCampaignExperiments = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.MutateCampaignExperimentsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.MutateCampaignExperimentsResponse.FromString,
        )
    self.GraduateCampaignExperiment = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GraduateCampaignExperimentRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GraduateCampaignExperimentResponse.FromString,
        )
    self.PromoteCampaignExperiment = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.PromoteCampaignExperimentRequest.SerializeToString,
        response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
        )
    self.EndCampaignExperiment = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.EndCampaignExperimentRequest.SerializeToString,
    ...
    self.ListCampaignExperimentAsyncErrors = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.ListCampaignExperimentAsyncErrorsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.ListCampaignExperimentAsyncErrorsResponse.FromString,
        )
...
def add_CampaignExperimentServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetCampaignExperiment': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GetCampaignExperimentRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v2_dot_resources_dot_campaign__experiment__pb2.CampaignExperiment.SerializeToString,
      ),
      'CreateCampaignExperiment': grpc.unary_unary_rpc_method_handler(
          servicer.CreateCampaignExperiment,
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.CreateCampaignExperimentRequest.FromString,
          response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'MutateCampaignExperiments': grpc.unary_unary_rpc_method_handler(
          servicer.MutateCampaignExperiments,
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.MutateCampaignExperimentsRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.MutateCampaignExperimentsResponse.SerializeToString,
      ),
      'GraduateCampaignExperiment': grpc.unary_unary_rpc_method_handler(
          servicer.GraduateCampaignExperiment,
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GraduateCampaignExperimentRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.GraduateCampaignExperimentResponse.SerializeToString,
      ),
      'PromoteCampaignExperiment': grpc.unary_unary_rpc_method_handler(
          servicer.PromoteCampaignExperiment,
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.PromoteCampaignExperimentRequest.FromString,
          response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'EndCampaignExperiment': grpc.unary_unary_rpc_method_handler(
          servicer.EndCampaignExperiment,
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.EndCampaignExperimentRequest.FromString,
      ...
      'ListCampaignExperimentAsyncErrors': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.ListCampaignExperimentAsyncErrorsRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v2_dot_services_dot_campaign__experiment__service__pb2.ListCampaignExperimentAsyncErrorsResponse.SerializeToString,
      ),
  }
