...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/manager_link_error.proto',
...
ManagerLinkErrorEnum = _reflection.GeneratedProtocolMessageType('ManagerLinkErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.manager_link_error_pb2'
