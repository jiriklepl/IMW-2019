...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/partial_failure_error.proto',
...
PartialFailureErrorEnum = _reflection.GeneratedProtocolMessageType('PartialFailureErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.partial_failure_error_pb2'
