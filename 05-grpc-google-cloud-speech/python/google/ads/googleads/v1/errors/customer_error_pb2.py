...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/customer_error.proto',
...
CustomerErrorEnum = _reflection.GeneratedProtocolMessageType('CustomerErrorEnum', (_message.Message,), {
  'DESCRIPTOR' : _CUSTOMERERRORENUM,
  '__module__' : 'google.ads.googleads.v1.errors.customer_error_pb2'
