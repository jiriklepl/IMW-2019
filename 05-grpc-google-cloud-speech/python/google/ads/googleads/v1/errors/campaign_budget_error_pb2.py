...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/campaign_budget_error.proto',
...
CampaignBudgetErrorEnum = _reflection.GeneratedProtocolMessageType('CampaignBudgetErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.campaign_budget_error_pb2'
