...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/range_error.proto',
...
RangeErrorEnum = _reflection.GeneratedProtocolMessageType('RangeErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.range_error_pb2'
