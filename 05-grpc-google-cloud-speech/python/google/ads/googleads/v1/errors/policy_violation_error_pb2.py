...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/policy_violation_error.proto',
...
PolicyViolationErrorEnum = _reflection.GeneratedProtocolMessageType('PolicyViolationErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.policy_violation_error_pb2'
