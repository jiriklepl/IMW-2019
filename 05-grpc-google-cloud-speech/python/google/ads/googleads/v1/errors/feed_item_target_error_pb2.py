...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/feed_item_target_error.proto',
...
FeedItemTargetErrorEnum = _reflection.GeneratedProtocolMessageType('FeedItemTargetErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.feed_item_target_error_pb2'
