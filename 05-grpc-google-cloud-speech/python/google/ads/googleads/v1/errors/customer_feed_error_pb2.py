...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/customer_feed_error.proto',
...
CustomerFeedErrorEnum = _reflection.GeneratedProtocolMessageType('CustomerFeedErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.customer_feed_error_pb2'
