...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/youtube_video_registration_error.proto',
...
YoutubeVideoRegistrationErrorEnum = _reflection.GeneratedProtocolMessageType('YoutubeVideoRegistrationErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.youtube_video_registration_error_pb2'
