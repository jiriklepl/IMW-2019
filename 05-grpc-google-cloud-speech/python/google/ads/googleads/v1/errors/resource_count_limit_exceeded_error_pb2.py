...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/resource_count_limit_exceeded_error.proto',
...
ResourceCountLimitExceededErrorEnum = _reflection.GeneratedProtocolMessageType('ResourceCountLimitExceededErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.resource_count_limit_exceeded_error_pb2'
