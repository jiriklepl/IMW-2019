...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/keyword_plan_idea_error.proto',
...
KeywordPlanIdeaErrorEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanIdeaErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.keyword_plan_idea_error_pb2'
