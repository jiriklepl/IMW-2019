...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/errors/extension_feed_item_error.proto',
...
ExtensionFeedItemErrorEnum = _reflection.GeneratedProtocolMessageType('ExtensionFeedItemErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.errors.extension_feed_item_error_pb2'
