...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/resources/payments_account.proto',
...
PaymentsAccount = _reflection.GeneratedProtocolMessageType('PaymentsAccount', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.resources.payments_account_pb2'
