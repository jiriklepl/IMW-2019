...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/resources/customer_client_link.proto',
...
_CUSTOMERCLIENTLINK.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v1_dot_enums_dot_manager__link__status__pb2._MANAGERLINKSTATUSENUM_MANAGERLINKSTATUS
...
CustomerClientLink = _reflection.GeneratedProtocolMessageType('CustomerClientLink', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.resources.customer_client_link_pb2'
