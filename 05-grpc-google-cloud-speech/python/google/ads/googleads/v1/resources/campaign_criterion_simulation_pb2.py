...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/resources/campaign_criterion_simulation.proto',
...
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v1_dot_enums_dot_simulation__type__pb2._SIMULATIONTYPEENUM_SIMULATIONTYPE
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['modification_method'].enum_type = google_dot_ads_dot_googleads_dot_v1_dot_enums_dot_simulation__modification__method__pb2._SIMULATIONMODIFICATIONMETHODENUM_SIMULATIONMODIFICATIONMETHOD
...
_CAMPAIGNCRITERIONSIMULATION.fields_by_name['bid_modifier_point_list'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_common_dot_simulation__pb2._BIDMODIFIERSIMULATIONPOINTLIST
...
CampaignCriterionSimulation = _reflection.GeneratedProtocolMessageType('CampaignCriterionSimulation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.resources.campaign_criterion_simulation_pb2'
