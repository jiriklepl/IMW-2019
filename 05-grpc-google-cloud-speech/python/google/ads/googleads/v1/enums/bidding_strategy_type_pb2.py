...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/bidding_strategy_type.proto',
...
BiddingStrategyTypeEnum = _reflection.GeneratedProtocolMessageType('BiddingStrategyTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.bidding_strategy_type_pb2'
