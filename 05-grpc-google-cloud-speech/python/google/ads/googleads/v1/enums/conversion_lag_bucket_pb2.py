...
_CONVERSIONLAGBUCKETENUM_CONVERSIONLAGBUCKET = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v1.enums.ConversionLagBucketEnum.ConversionLagBucket',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CONVERSIONLAGBUCKETENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.enums.ConversionLagBucketEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
ConversionLagBucketEnum = _reflection.GeneratedProtocolMessageType('ConversionLagBucketEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.conversion_lag_bucket_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.ConversionLagBucketEnum)
  })
