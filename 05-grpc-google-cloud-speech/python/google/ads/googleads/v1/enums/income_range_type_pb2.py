...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/income_range_type.proto',
...
IncomeRangeTypeEnum = _reflection.GeneratedProtocolMessageType('IncomeRangeTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.income_range_type_pb2'
