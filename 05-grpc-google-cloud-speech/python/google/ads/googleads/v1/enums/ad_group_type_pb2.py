...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/ad_group_type.proto',
...
_ADGROUPTYPEENUM_ADGROUPTYPE = _descriptor.EnumDescriptor(
  name='AdGroupType',
  full_name='google.ads.googleads.v1.enums.AdGroupTypeEnum.AdGroupType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_ADGROUPTYPEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.enums.AdGroupTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
AdGroupTypeEnum = _reflection.GeneratedProtocolMessageType('AdGroupTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.ad_group_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.AdGroupTypeEnum)
  })
