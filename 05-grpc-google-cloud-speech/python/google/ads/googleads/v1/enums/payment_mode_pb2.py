...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/payment_mode.proto',
...
_PAYMENTMODEENUM_PAYMENTMODE = _descriptor.EnumDescriptor(
  name='PaymentMode',
  full_name='google.ads.googleads.v1.enums.PaymentModeEnum.PaymentMode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_PAYMENTMODEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.enums.PaymentModeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
PaymentModeEnum = _reflection.GeneratedProtocolMessageType('PaymentModeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.payment_mode_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.PaymentModeEnum)
  })
