...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/budget_type.proto',
...
_BUDGETTYPEENUM_BUDGETTYPE = _descriptor.EnumDescriptor(
  name='BudgetType',
  full_name='google.ads.googleads.v1.enums.BudgetTypeEnum.BudgetType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BUDGETTYPEENUM = _descriptor.Descriptor(
  name='BudgetTypeEnum',
  full_name='google.ads.googleads.v1.enums.BudgetTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
BudgetTypeEnum = _reflection.GeneratedProtocolMessageType('BudgetTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.budget_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.BudgetTypeEnum)
  })
