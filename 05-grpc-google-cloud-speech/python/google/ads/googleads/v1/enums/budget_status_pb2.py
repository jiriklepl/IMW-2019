...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/budget_status.proto',
...
BudgetStatusEnum = _reflection.GeneratedProtocolMessageType('BudgetStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.budget_status_pb2'
