...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/device.proto',
...
_DEVICEENUM_DEVICE = _descriptor.EnumDescriptor(
  name='Device',
  full_name='google.ads.googleads.v1.enums.DeviceEnum.Device',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_DEVICEENUM = _descriptor.Descriptor(
  name='DeviceEnum',
  full_name='google.ads.googleads.v1.enums.DeviceEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
DeviceEnum = _reflection.GeneratedProtocolMessageType('DeviceEnum', (_message.Message,), {
  'DESCRIPTOR' : _DEVICEENUM,
  '__module__' : 'google.ads.googleads.v1.enums.device_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.DeviceEnum)
  })
