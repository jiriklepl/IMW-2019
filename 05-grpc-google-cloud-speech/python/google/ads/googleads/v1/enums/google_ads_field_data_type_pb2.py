...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/google_ads_field_data_type.proto',
...
_GOOGLEADSFIELDDATATYPEENUM_GOOGLEADSFIELDDATATYPE = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v1.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_GOOGLEADSFIELDDATATYPEENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.enums.GoogleAdsFieldDataTypeEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
GoogleAdsFieldDataTypeEnum = _reflection.GeneratedProtocolMessageType('GoogleAdsFieldDataTypeEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.google_ads_field_data_type_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.enums.GoogleAdsFieldDataTypeEnum)
  })
