...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/enums/feed_mapping_status.proto',
...
FeedMappingStatusEnum = _reflection.GeneratedProtocolMessageType('FeedMappingStatusEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.enums.feed_mapping_status_pb2'
