...
_GENERATEKEYWORDIDEASREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.customer_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='language', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.language', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='geo_target_constants', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.geo_target_constants', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_plan_network', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.keyword_plan_network', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_and_url_seed', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.keyword_and_url_seed', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_seed', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.keyword_seed', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='url_seed', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.url_seed', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='seed', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeasRequest.seed',
...
_KEYWORDANDURLSEED = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordAndUrlSeed',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='google.ads.googleads.v1.services.KeywordAndUrlSeed.url', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keywords', full_name='google.ads.googleads.v1.services.KeywordAndUrlSeed.keywords', index=1,
...
_KEYWORDSEED = _descriptor.Descriptor(
  name='KeywordSeed',
  full_name='google.ads.googleads.v1.services.KeywordSeed',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keywords', full_name='google.ads.googleads.v1.services.KeywordSeed.keywords', index=0,
...
_URLSEED = _descriptor.Descriptor(
  name='UrlSeed',
  full_name='google.ads.googleads.v1.services.UrlSeed',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='google.ads.googleads.v1.services.UrlSeed.url', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEKEYWORDIDEARESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateKeywordIdeaResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeaResponse.results', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEKEYWORDIDEARESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateKeywordIdeaResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='text', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeaResult.text', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_idea_metrics', full_name='google.ads.googleads.v1.services.GenerateKeywordIdeaResult.keyword_idea_metrics', index=1,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEKEYWORDIDEASREQUEST.fields_by_name['keyword_plan_network'].enum_type = google_dot_ads_dot_googleads_dot_v1_dot_enums_dot_keyword__plan__network__pb2._KEYWORDPLANNETWORKENUM_KEYWORDPLANNETWORK
...
_GENERATEKEYWORDIDEARESULT.fields_by_name['keyword_idea_metrics'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_common_dot_keyword__plan__common__pb2._KEYWORDPLANHISTORICALMETRICS
...
GenerateKeywordIdeasRequest = _reflection.GeneratedProtocolMessageType('GenerateKeywordIdeasRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateKeywordIdeasRequest)
  })
...
KeywordAndUrlSeed = _reflection.GeneratedProtocolMessageType('KeywordAndUrlSeed', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordAndUrlSeed)
  })
...
KeywordSeed = _reflection.GeneratedProtocolMessageType('KeywordSeed', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordSeed)
  })
...
UrlSeed = _reflection.GeneratedProtocolMessageType('UrlSeed', (_message.Message,), {
  'DESCRIPTOR' : _URLSEED,
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.UrlSeed)
  })
...
GenerateKeywordIdeaResponse = _reflection.GeneratedProtocolMessageType('GenerateKeywordIdeaResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateKeywordIdeaResponse)
  })
...
GenerateKeywordIdeaResult = _reflection.GeneratedProtocolMessageType('GenerateKeywordIdeaResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_idea_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateKeywordIdeaResult)
  })
...
_KEYWORDPLANIDEASERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordPlanIdeaService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v1.services.KeywordPlanIdeaService.GenerateKeywordIdeas',
    index=0,
    containing_service=None,
    input_type=_GENERATEKEYWORDIDEASREQUEST,
    output_type=_GENERATEKEYWORDIDEARESPONSE,
    serialized_options=b'\202\323\344\223\0027\"2/v1/customers/{customer_id=*}:generateKeywordIdeas:\001*',
  ),
])
