...
class GoogleAdsServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Search = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsResponse.FromString,
        )
    self.Mutate = channel.unary_unary(
        '/google.ads.googleads.v1.services.GoogleAdsService/Mutate',
        request_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsResponse.FromString,
        )
...
def add_GoogleAdsServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'Search': grpc.unary_unary_rpc_method_handler(
          servicer.Search,
          request_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.SearchGoogleAdsResponse.SerializeToString,
      ),
      'Mutate': grpc.unary_unary_rpc_method_handler(
          servicer.Mutate,
          request_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_google__ads__service__pb2.MutateGoogleAdsResponse.SerializeToString,
      ),
  }
