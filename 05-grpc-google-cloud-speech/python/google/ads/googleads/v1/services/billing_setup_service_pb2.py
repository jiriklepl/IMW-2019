...
_GETBILLINGSETUPREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GetBillingSetupRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.GetBillingSetupRequest.resource_name', index=0,
...
_MUTATEBILLINGSETUPREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateBillingSetupRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v1.services.MutateBillingSetupRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operation', full_name='google.ads.googleads.v1.services.MutateBillingSetupRequest.operation', index=1,
...
_BILLINGSETUPOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.BillingSetupOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v1.services.BillingSetupOperation.create', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v1.services.BillingSetupOperation.remove', index=1,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v1.services.BillingSetupOperation.operation',
...
_MUTATEBILLINGSETUPRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateBillingSetupResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='google.ads.googleads.v1.services.MutateBillingSetupResponse.result', index=0,
...
_MUTATEBILLINGSETUPRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateBillingSetupResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.MutateBillingSetupResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BILLINGSETUPOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_billing__setup__pb2._BILLINGSETUP
...
GetBillingSetupRequest = _reflection.GeneratedProtocolMessageType('GetBillingSetupRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.billing_setup_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GetBillingSetupRequest)
  })
...
MutateBillingSetupRequest = _reflection.GeneratedProtocolMessageType('MutateBillingSetupRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.billing_setup_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateBillingSetupRequest)
  })
...
BillingSetupOperation = _reflection.GeneratedProtocolMessageType('BillingSetupOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.billing_setup_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.BillingSetupOperation)
  })
...
MutateBillingSetupResponse = _reflection.GeneratedProtocolMessageType('MutateBillingSetupResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.billing_setup_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateBillingSetupResponse)
  })
...
MutateBillingSetupResult = _reflection.GeneratedProtocolMessageType('MutateBillingSetupResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.billing_setup_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateBillingSetupResult)
  })
...
_BILLINGSETUPSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v1.services.BillingSetupService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v1.services.BillingSetupService.GetBillingSetup',
    index=0,
    containing_service=None,
    input_type=_GETBILLINGSETUPREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_billing__setup__pb2._BILLINGSETUP,
    serialized_options=b'\202\323\344\223\0021\022//v1/{resource_name=customers/*/billingSetups/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateBillingSetup',
    full_name='google.ads.googleads.v1.services.BillingSetupService.MutateBillingSetup',
    index=1,
    containing_service=None,
    input_type=_MUTATEBILLINGSETUPREQUEST,
    output_type=_MUTATEBILLINGSETUPRESPONSE,
    serialized_options=b'\202\323\344\223\0027\"2/v1/customers/{customer_id=*}/billingSetups:mutate:\001*',
  ),
])
