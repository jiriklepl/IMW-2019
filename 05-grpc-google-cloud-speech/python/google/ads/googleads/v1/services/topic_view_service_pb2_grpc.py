...
from google.ads.googleads.v1.services import topic_view_service_pb2 as google_dot_ads_dot_googleads_dot_v1_dot_services_dot_topic__view__service__pb2
...
class TopicViewServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetTopicView = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_topic__view__service__pb2.GetTopicViewRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_topic__view__pb2.TopicView.FromString,
        )
...
def add_TopicViewServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetTopicView': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_topic__view__service__pb2.GetTopicViewRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_topic__view__pb2.TopicView.SerializeToString,
      ),
  }
