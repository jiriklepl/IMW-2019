...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/mobile_app_category_constant_service.proto',
...
GetMobileAppCategoryConstantRequest = _reflection.GeneratedProtocolMessageType('GetMobileAppCategoryConstantRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.mobile_app_category_constant_service_pb2'
...
_MOBILEAPPCATEGORYCONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_mobile__app__category__constant__pb2._MOBILEAPPCATEGORYCONSTANT,
    serialized_options=b'\202\323\344\223\0022\0220/v1/{resource_name=mobileAppCategoryConstants/*}',
  ),
])
