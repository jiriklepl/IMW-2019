...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/domain_category_service.proto',
...
GetDomainCategoryRequest = _reflection.GeneratedProtocolMessageType('GetDomainCategoryRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.domain_category_service_pb2'
...
_DOMAINCATEGORYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_domain__category__pb2._DOMAINCATEGORY,
    serialized_options=b'\202\323\344\223\0024\0222/v1/{resource_name=customers/*/domainCategories/*}',
  ),
])
