...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/operating_system_version_constant_service.proto',
...
GetOperatingSystemVersionConstantRequest = _reflection.GeneratedProtocolMessageType('GetOperatingSystemVersionConstantRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.operating_system_version_constant_service_pb2'
...
_OPERATINGSYSTEMVERSIONCONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_operating__system__version__constant__pb2._OPERATINGSYSTEMVERSIONCONSTANT,
    serialized_options=b'\202\323\344\223\0027\0225/v1/{resource_name=operatingSystemVersionConstants/*}',
  ),
])
