...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/customer_service.proto',
...
_CREATECUSTOMERCLIENTREQUEST.fields_by_name['customer_client'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_customer__pb2._CUSTOMER
_CUSTOMEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_customer__pb2._CUSTOMER
...
GetCustomerRequest = _reflection.GeneratedProtocolMessageType('GetCustomerRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.customer_service_pb2'
...
_CUSTOMERSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_customer__pb2._CUSTOMER,
    serialized_options=b'\202\323\344\223\002!\022\037/v1/{resource_name=customers/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomer',
    ...
    serialized_options=b'\202\323\344\223\002)\"$/v1/customers/{customer_id=*}:mutate:\001*',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\'\022%/v1/customers:listAccessibleCustomers',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0027\"2/v1/customers/{customer_id=*}:createCustomerClient:\001*',
  ),
])
