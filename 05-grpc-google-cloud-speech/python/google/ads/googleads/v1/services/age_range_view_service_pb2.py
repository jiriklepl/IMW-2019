...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/age_range_view_service.proto',
...
GetAgeRangeViewRequest = _reflection.GeneratedProtocolMessageType('GetAgeRangeViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.age_range_view_service_pb2'
...
_AGERANGEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_age__range__view__pb2._AGERANGEVIEW,
    serialized_options=b'\202\323\344\223\0021\022//v1/{resource_name=customers/*/ageRangeViews/*}',
  ),
])
