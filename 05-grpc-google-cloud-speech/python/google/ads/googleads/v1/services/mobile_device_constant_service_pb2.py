...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/mobile_device_constant_service.proto',
...
GetMobileDeviceConstantRequest = _reflection.GeneratedProtocolMessageType('GetMobileDeviceConstantRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.mobile_device_constant_service_pb2'
...
_MOBILEDEVICECONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_mobile__device__constant__pb2._MOBILEDEVICECONSTANT,
    serialized_options=b'\202\323\344\223\002-\022+/v1/{resource_name=mobileDeviceConstants/*}',
  ),
])
