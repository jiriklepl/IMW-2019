...
_GETADGROUPFEEDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GetAdGroupFeedRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.GetAdGroupFeedRequest.resource_name', index=0,
...
_MUTATEADGROUPFEEDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsRequest.validate_only', index=3,
...
_ADGROUPFEEDOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.AdGroupFeedOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v1.services.AdGroupFeedOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v1.services.AdGroupFeedOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v1.services.AdGroupFeedOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v1.services.AdGroupFeedOperation.remove', index=3,
...
_MUTATEADGROUPFEEDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPFEEDRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateAdGroupFeedResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.MutateAdGroupFeedResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPFEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__feed__pb2._ADGROUPFEED
_ADGROUPFEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__feed__pb2._ADGROUPFEED
...
GetAdGroupFeedRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupFeedRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GetAdGroupFeedRequest)
  })
...
MutateAdGroupFeedsRequest = _reflection.GeneratedProtocolMessageType('MutateAdGroupFeedsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupFeedsRequest)
  })
...
AdGroupFeedOperation = _reflection.GeneratedProtocolMessageType('AdGroupFeedOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.AdGroupFeedOperation)
  })
...
MutateAdGroupFeedsResponse = _reflection.GeneratedProtocolMessageType('MutateAdGroupFeedsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupFeedsResponse)
  })
...
MutateAdGroupFeedResult = _reflection.GeneratedProtocolMessageType('MutateAdGroupFeedResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_feed_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupFeedResult)
  })
...
_ADGROUPFEEDSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v1.services.AdGroupFeedService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetAdGroupFeed',
    full_name='google.ads.googleads.v1.services.AdGroupFeedService.GetAdGroupFeed',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPFEEDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__feed__pb2._ADGROUPFEED,
    serialized_options=b'\202\323\344\223\0020\022./v1/{resource_name=customers/*/adGroupFeeds/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupFeeds',
    full_name='google.ads.googleads.v1.services.AdGroupFeedService.MutateAdGroupFeeds',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPFEEDSREQUEST,
    output_type=_MUTATEADGROUPFEEDSRESPONSE,
    serialized_options=b'\202\323\344\223\0026\"1/v1/customers/{customer_id=*}/adGroupFeeds:mutate:\001*',
  ),
])
