...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/topic_constant_service.proto',
...
GetTopicConstantRequest = _reflection.GeneratedProtocolMessageType('GetTopicConstantRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.topic_constant_service_pb2'
...
_TOPICCONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_topic__constant__pb2._TOPICCONSTANT,
    serialized_options=b'\202\323\344\223\002&\022$/v1/{resource_name=topicConstants/*}',
  ),
])
