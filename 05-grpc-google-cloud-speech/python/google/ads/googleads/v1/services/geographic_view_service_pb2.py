...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/geographic_view_service.proto',
...
GetGeographicViewRequest = _reflection.GeneratedProtocolMessageType('GetGeographicViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.geographic_view_service_pb2'
...
_GEOGRAPHICVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_geographic__view__pb2._GEOGRAPHICVIEW,
    serialized_options=b'\202\323\344\223\0023\0221/v1/{resource_name=customers/*/geographicViews/*}',
  ),
])
