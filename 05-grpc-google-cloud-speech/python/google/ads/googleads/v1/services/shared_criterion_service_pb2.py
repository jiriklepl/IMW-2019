...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/shared_criterion_service.proto',
...
_SHAREDCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_shared__criterion__pb2._SHAREDCRITERION
...
GetSharedCriterionRequest = _reflection.GeneratedProtocolMessageType('GetSharedCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.shared_criterion_service_pb2'
...
_SHAREDCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_shared__criterion__pb2._SHAREDCRITERION,
    serialized_options=b'\202\323\344\223\0022\0220/v1/{resource_name=customers/*/sharedCriteria/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0028\"3/v1/customers/{customer_id=*}/sharedCriteria:mutate:\001*',
  ),
])
