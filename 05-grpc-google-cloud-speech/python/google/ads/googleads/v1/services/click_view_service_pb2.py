...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/click_view_service.proto',
...
GetClickViewRequest = _reflection.GeneratedProtocolMessageType('GetClickViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.click_view_service_pb2'
...
_CLICKVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_click__view__pb2._CLICKVIEW,
    serialized_options=b'\202\323\344\223\002.\022,/v1/{resource_name=customers/*/clickViews/*}',
  ),
])
