...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/feed_item_target_service.proto',
...
_FEEDITEMTARGETOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_feed__item__target__pb2._FEEDITEMTARGET
...
GetFeedItemTargetRequest = _reflection.GeneratedProtocolMessageType('GetFeedItemTargetRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.feed_item_target_service_pb2'
...
_FEEDITEMTARGETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_feed__item__target__pb2._FEEDITEMTARGET,
    serialized_options=b'\202\323\344\223\0023\0221/v1/{resource_name=customers/*/feedItemTargets/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\0029\"4/v1/customers/{customer_id=*}/feedItemTargets:mutate:\001*',
  ),
])
