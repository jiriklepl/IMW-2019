...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/paid_organic_search_term_view_service.proto',
...
GetPaidOrganicSearchTermViewRequest = _reflection.GeneratedProtocolMessageType('GetPaidOrganicSearchTermViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.paid_organic_search_term_view_service_pb2'
...
_PAIDORGANICSEARCHTERMVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_paid__organic__search__term__view__pb2._PAIDORGANICSEARCHTERMVIEW,
    serialized_options=b'\202\323\344\223\002>\022</v1/{resource_name=customers/*/paidOrganicSearchTermViews/*}',
  ),
])
