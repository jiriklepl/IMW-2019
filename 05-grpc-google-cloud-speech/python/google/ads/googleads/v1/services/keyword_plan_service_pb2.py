...
from google.ads.googleads.v1.common import keyword_plan_common_pb2 as google_dot_ads_dot_googleads_dot_v1_dot_common_dot_keyword__plan__common__pb2
...
_GETKEYWORDPLANREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GetKeywordPlanRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.GetKeywordPlanRequest.resource_name', index=0,
...
_MUTATEKEYWORDPLANSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v1.services.MutateKeywordPlansRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v1.services.MutateKeywordPlansRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v1.services.MutateKeywordPlansRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v1.services.MutateKeywordPlansRequest.validate_only', index=3,
...
_KEYWORDPLANOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordPlanOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v1.services.KeywordPlanOperation.update_mask', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v1.services.KeywordPlanOperation.create', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v1.services.KeywordPlanOperation.update', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v1.services.KeywordPlanOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v1.services.KeywordPlanOperation.operation',
...
_MUTATEKEYWORDPLANSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateKeywordPlansResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v1.services.MutateKeywordPlansResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v1.services.MutateKeywordPlansResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEKEYWORDPLANSRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateKeywordPlansResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.MutateKeywordPlansResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEFORECASTMETRICSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateForecastMetricsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keyword_plan', full_name='google.ads.googleads.v1.services.GenerateForecastMetricsRequest.keyword_plan', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEFORECASTMETRICSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='campaign_forecasts', full_name='google.ads.googleads.v1.services.GenerateForecastMetricsResponse.campaign_forecasts', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ad_group_forecasts', full_name='google.ads.googleads.v1.services.GenerateForecastMetricsResponse.ad_group_forecasts', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_forecasts', full_name='google.ads.googleads.v1.services.GenerateForecastMetricsResponse.keyword_forecasts', index=2,
...
_KEYWORDPLANCAMPAIGNFORECAST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='keyword_plan_campaign', full_name='google.ads.googleads.v1.services.KeywordPlanCampaignForecast.keyword_plan_campaign', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='campaign_forecast', full_name='google.ads.googleads.v1.services.KeywordPlanCampaignForecast.campaign_forecast', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANADGROUPFORECAST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='keyword_plan_ad_group', full_name='google.ads.googleads.v1.services.KeywordPlanAdGroupForecast.keyword_plan_ad_group', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ad_group_forecast', full_name='google.ads.googleads.v1.services.KeywordPlanAdGroupForecast.ad_group_forecast', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANKEYWORDFORECAST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordPlanKeywordForecast',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keyword_plan_ad_group_keyword', full_name='google.ads.googleads.v1.services.KeywordPlanKeywordForecast.keyword_plan_ad_group_keyword', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_forecast', full_name='google.ads.googleads.v1.services.KeywordPlanKeywordForecast.keyword_forecast', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FORECASTMETRICS = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.ForecastMetrics',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='impressions', full_name='google.ads.googleads.v1.services.ForecastMetrics.impressions', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='ctr', full_name='google.ads.googleads.v1.services.ForecastMetrics.ctr', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='average_cpc', full_name='google.ads.googleads.v1.services.ForecastMetrics.average_cpc', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='clicks', full_name='google.ads.googleads.v1.services.ForecastMetrics.clicks', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cost_micros', full_name='google.ads.googleads.v1.services.ForecastMetrics.cost_micros', index=4,
...
_GENERATEHISTORICALMETRICSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateHistoricalMetricsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keyword_plan', full_name='google.ads.googleads.v1.services.GenerateHistoricalMetricsRequest.keyword_plan', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GENERATEHISTORICALMETRICSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GenerateHistoricalMetricsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='metrics', full_name='google.ads.googleads.v1.services.GenerateHistoricalMetricsResponse.metrics', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANKEYWORDHISTORICALMETRICS = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordPlanKeywordHistoricalMetrics',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='search_query', full_name='google.ads.googleads.v1.services.KeywordPlanKeywordHistoricalMetrics.search_query', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='keyword_metrics', full_name='google.ads.googleads.v1.services.KeywordPlanKeywordHistoricalMetrics.keyword_metrics', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN
_KEYWORDPLANOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN
...
_KEYWORDPLANKEYWORDHISTORICALMETRICS.fields_by_name['keyword_metrics'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_common_dot_keyword__plan__common__pb2._KEYWORDPLANHISTORICALMETRICS
...
GetKeywordPlanRequest = _reflection.GeneratedProtocolMessageType('GetKeywordPlanRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GetKeywordPlanRequest)
  })
...
MutateKeywordPlansRequest = _reflection.GeneratedProtocolMessageType('MutateKeywordPlansRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateKeywordPlansRequest)
  })
...
KeywordPlanOperation = _reflection.GeneratedProtocolMessageType('KeywordPlanOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordPlanOperation)
  })
...
MutateKeywordPlansResponse = _reflection.GeneratedProtocolMessageType('MutateKeywordPlansResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateKeywordPlansResponse)
  })
...
MutateKeywordPlansResult = _reflection.GeneratedProtocolMessageType('MutateKeywordPlansResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateKeywordPlansResult)
  })
...
GenerateForecastMetricsRequest = _reflection.GeneratedProtocolMessageType('GenerateForecastMetricsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateForecastMetricsRequest)
  })
...
GenerateForecastMetricsResponse = _reflection.GeneratedProtocolMessageType('GenerateForecastMetricsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateForecastMetricsResponse)
  })
...
KeywordPlanCampaignForecast = _reflection.GeneratedProtocolMessageType('KeywordPlanCampaignForecast', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordPlanCampaignForecast)
  })
...
KeywordPlanKeywordForecast = _reflection.GeneratedProtocolMessageType('KeywordPlanKeywordForecast', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordPlanKeywordForecast)
  })
...
ForecastMetrics = _reflection.GeneratedProtocolMessageType('ForecastMetrics', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.ForecastMetrics)
  })
...
GenerateHistoricalMetricsRequest = _reflection.GeneratedProtocolMessageType('GenerateHistoricalMetricsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateHistoricalMetricsRequest)
  })
...
GenerateHistoricalMetricsResponse = _reflection.GeneratedProtocolMessageType('GenerateHistoricalMetricsResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GenerateHistoricalMetricsResponse)
  })
...
KeywordPlanKeywordHistoricalMetrics = _reflection.GeneratedProtocolMessageType('KeywordPlanKeywordHistoricalMetrics', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.keyword_plan_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.KeywordPlanKeywordHistoricalMetrics)
  })
...
_KEYWORDPLANSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v1.services.KeywordPlanService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='GetKeywordPlan',
    full_name='google.ads.googleads.v1.services.KeywordPlanService.GetKeywordPlan',
    index=0,
    containing_service=None,
    input_type=_GETKEYWORDPLANREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_keyword__plan__pb2._KEYWORDPLAN,
    serialized_options=b'\202\323\344\223\0020\022./v1/{resource_name=customers/*/keywordPlans/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateKeywordPlans',
    full_name='google.ads.googleads.v1.services.KeywordPlanService.MutateKeywordPlans',
    index=1,
    containing_service=None,
    input_type=_MUTATEKEYWORDPLANSREQUEST,
    output_type=_MUTATEKEYWORDPLANSRESPONSE,
    serialized_options=b'\202\323\344\223\0026\"1/v1/customers/{customer_id=*}/keywordPlans:mutate:\001*',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002J\"E/v1/{keyword_plan=customers/*/keywordPlans/*}:generateForecastMetrics:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='GenerateHistoricalMetrics',
    full_name='google.ads.googleads.v1.services.KeywordPlanService.GenerateHistoricalMetrics',
    index=3,
    containing_service=None,
    input_type=_GENERATEHISTORICALMETRICSREQUEST,
    output_type=_GENERATEHISTORICALMETRICSRESPONSE,
    serialized_options=b'\202\323\344\223\002L\"G/v1/{keyword_plan=customers/*/keywordPlans/*}:generateHistoricalMetrics:\001*',
  ),
])
