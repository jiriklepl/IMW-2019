...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v1/services/ad_group_criterion_service.proto',
...
_GETADGROUPCRITERIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.GetAdGroupCriterionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.GetAdGroupCriterionRequest.resource_name', index=0,
...
_MUTATEADGROUPCRITERIAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest.operations', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest.partial_failure', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest.validate_only', index=3,
...
_ADGROUPCRITERIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.AdGroupCriterionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v1.services.AdGroupCriterionOperation.update_mask', index=0,
...
_MUTATEADGROUPCRITERIARESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse.partial_failure_error', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPCRITERIONRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v1.services.MutateAdGroupCriterionResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPCRITERIONOPERATION.fields_by_name['exempt_policy_violation_keys'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_common_dot_policy__pb2._POLICYVIOLATIONKEY
_ADGROUPCRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
_ADGROUPCRITERIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION
...
GetAdGroupCriterionRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.GetAdGroupCriterionRequest)
  })
...
MutateAdGroupCriteriaRequest = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriteriaRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupCriteriaRequest)
  })
...
AdGroupCriterionOperation = _reflection.GeneratedProtocolMessageType('AdGroupCriterionOperation', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.AdGroupCriterionOperation)
  })
...
MutateAdGroupCriteriaResponse = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriteriaResponse', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupCriteriaResponse)
  })
...
MutateAdGroupCriterionResult = _reflection.GeneratedProtocolMessageType('MutateAdGroupCriterionResult', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v1.services.ad_group_criterion_service_pb2'
  # @@protoc_insertion_point(class_scope:google.ads.googleads.v1.services.MutateAdGroupCriterionResult)
  })
...
_ADGROUPCRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v1.services.AdGroupCriterionService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v1.services.AdGroupCriterionService.GetAdGroupCriterion',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPCRITERIONREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_ad__group__criterion__pb2._ADGROUPCRITERION,
    serialized_options=b'\202\323\344\223\0023\0221/v1/{resource_name=customers/*/adGroupCriteria/*}',
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupCriteria',
    full_name='google.ads.googleads.v1.services.AdGroupCriterionService.MutateAdGroupCriteria',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPCRITERIAREQUEST,
    output_type=_MUTATEADGROUPCRITERIARESPONSE,
    serialized_options=b'\202\323\344\223\0029\"4/v1/customers/{customer_id=*}/adGroupCriteria:mutate:\001*',
  ),
])
