...
from google.ads.googleads.v1.services import product_group_view_service_pb2 as google_dot_ads_dot_googleads_dot_v1_dot_services_dot_product__group__view__service__pb2
...
class ProductGroupViewServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetProductGroupView = channel.unary_unary(
        ...
        request_serializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_product__group__view__service__pb2.GetProductGroupViewRequest.SerializeToString,
        response_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_product__group__view__pb2.ProductGroupView.FromString,
        )
...
def add_ProductGroupViewServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetProductGroupView': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_ads_dot_googleads_dot_v1_dot_services_dot_product__group__view__service__pb2.GetProductGroupViewRequest.FromString,
          response_serializer=google_dot_ads_dot_googleads_dot_v1_dot_resources_dot_product__group__view__pb2.ProductGroupView.SerializeToString,
      ),
  }
