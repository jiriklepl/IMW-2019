...
_EXPLAIN_EXPRSTEP = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='google.api.expr.v1alpha1.Explain.ExprStep.id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value_index', full_name='google.api.expr.v1alpha1.Explain.ExprStep.value_index', index=1,
...
_EXPLAIN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='google.api.expr.v1alpha1.Explain.values', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='expr_steps', full_name='google.api.expr.v1alpha1.Explain.expr_steps', index=1,
...
_EXPLAIN.fields_by_name['values'].message_type = google_dot_api_dot_expr_dot_v1alpha1_dot_value__pb2._VALUE
