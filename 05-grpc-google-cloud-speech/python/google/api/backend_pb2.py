...
_BACKENDRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_deadline', full_name='google.api.BackendRule.min_deadline', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operation_deadline', full_name='google.api.BackendRule.operation_deadline', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='path_translation', full_name='google.api.BackendRule.path_translation', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jwt_audience', full_name='google.api.BackendRule.jwt_audience', index=6,
...
_BACKENDRULE.fields_by_name['jwt_audience'].containing_oneof = _BACKENDRULE.oneofs_by_name['authentication']
