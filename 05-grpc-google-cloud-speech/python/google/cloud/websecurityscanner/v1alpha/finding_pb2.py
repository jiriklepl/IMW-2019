...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/websecurityscanner/v1alpha/finding.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2.DESCRIPTOR,])
...
_FINDING_FINDINGTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      name='FINDING_TYPE_UNSPECIFIED', index=0, number=0,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MIXED_CONTENT', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OUTDATED_LIBRARY', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ROSETTA_FLASH', index=3, number=5,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XSS_CALLBACK', index=4, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XSS_ERROR', index=5, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLEAR_TEXT_PASSWORD', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_CONTENT_TYPE', index=7, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='XSS_ANGULAR_CALLBACK', index=8, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_HEADER', index=9, number=9,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MISSPELLED_SECURITY_HEADER_NAME', index=10, number=10,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MISMATCHING_SECURITY_HEADER_VALUES', index=11, number=11,
      serialized_options=None,
      type=None),
  ],
...
_FINDING = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.websecurityscanner.v1alpha.Finding.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='finding_type', full_name='google.cloud.websecurityscanner.v1alpha.Finding.finding_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='http_method', full_name='google.cloud.websecurityscanner.v1alpha.Finding.http_method', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='fuzzed_url', full_name='google.cloud.websecurityscanner.v1alpha.Finding.fuzzed_url', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='body', full_name='google.cloud.websecurityscanner.v1alpha.Finding.body', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.websecurityscanner.v1alpha.Finding.description', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='reproduction_url', full_name='google.cloud.websecurityscanner.v1alpha.Finding.reproduction_url', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='frame_url', full_name='google.cloud.websecurityscanner.v1alpha.Finding.frame_url', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='final_url', full_name='google.cloud.websecurityscanner.v1alpha.Finding.final_url', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tracking_id', full_name='google.cloud.websecurityscanner.v1alpha.Finding.tracking_id', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='outdated_library', full_name='google.cloud.websecurityscanner.v1alpha.Finding.outdated_library', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='violating_resource', full_name='google.cloud.websecurityscanner.v1alpha.Finding.violating_resource', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vulnerable_headers', full_name='google.cloud.websecurityscanner.v1alpha.Finding.vulnerable_headers', index=12,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='vulnerable_parameters', full_name='google.cloud.websecurityscanner.v1alpha.Finding.vulnerable_parameters', index=13,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='xss', full_name='google.cloud.websecurityscanner.v1alpha.Finding.xss', index=14,
...
_FINDING.fields_by_name['outdated_library'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2._OUTDATEDLIBRARY
_FINDING.fields_by_name['violating_resource'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2._VIOLATINGRESOURCE
_FINDING.fields_by_name['vulnerable_headers'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2._VULNERABLEHEADERS
_FINDING.fields_by_name['vulnerable_parameters'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2._VULNERABLEPARAMETERS
_FINDING.fields_by_name['xss'].message_type = google_dot_cloud_dot_websecurityscanner_dot_v1alpha_dot_finding__addon__pb2._XSS
