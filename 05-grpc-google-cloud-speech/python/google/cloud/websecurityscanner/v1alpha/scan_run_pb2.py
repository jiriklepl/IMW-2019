...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/websecurityscanner/v1alpha/scan_run.proto',
...
_SCANRUN = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='execution_state', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.execution_state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='result_state', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.result_state', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.start_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.end_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='urls_crawled_count', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.urls_crawled_count', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='urls_tested_count', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.urls_tested_count', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='has_vulnerabilities', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.has_vulnerabilities', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='progress_percent', full_name='google.cloud.websecurityscanner.v1alpha.ScanRun.progress_percent', index=8,
