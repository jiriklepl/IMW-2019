...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/websecurityscanner/v1beta/scan_config_error.proto',
...
_SCANCONFIGERROR_CODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APPENGINE_API_BACKEND_ERROR', index=3, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APPENGINE_API_NOT_ACCESSIBLE', index=4, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='APPENGINE_DEFAULT_HOST_MISSING', index=5, number=4,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_USE_GOOGLE_COM_ACCOUNT', index=6, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_USE_OWNER_ACCOUNT', index=7, number=7,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPUTE_API_BACKEND_ERROR', index=8, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPUTE_API_NOT_ACCESSIBLE', index=9, number=9,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOGIN_URL_DOES_NOT_BELONG_TO_CURRENT_PROJECT', index=10, number=10,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOGIN_URL_MALFORMED', index=11, number=11,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOGIN_URL_MAPPED_TO_NON_ROUTABLE_ADDRESS', index=12, number=12,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOGIN_URL_MAPPED_TO_UNRESERVED_ADDRESS', index=13, number=13,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CUSTOM_LOGIN_URL_HAS_NON_ROUTABLE_IP_ADDRESS', index=14, number=14,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DUPLICATE_SCAN_NAME', index=16, number=16,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_FIELD_VALUE', index=17, number=18,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FAILED_TO_AUTHENTICATE_TO_TARGET', index=18, number=19,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FINDING_TYPE_UNSPECIFIED', index=19, number=20,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FORBIDDEN_TO_SCAN_COMPUTE', index=20, number=21,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FORBIDDEN_UPDATE_TO_MANAGED_SCAN', index=21, number=43,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MALFORMED_FILTER', index=22, number=22,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MALFORMED_RESOURCE_NAME', index=23, number=23,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PROJECT_INACTIVE', index=24, number=24,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REQUIRED_FIELD', index=25, number=25,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RESOURCE_NAME_INCONSISTENT', index=26, number=26,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SCAN_ALREADY_RUNNING', index=27, number=27,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SCAN_NOT_RUNNING', index=28, number=28,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_DOES_NOT_BELONG_TO_CURRENT_PROJECT', index=29, number=29,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_MALFORMED', index=30, number=30,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_MAPPED_TO_NON_ROUTABLE_ADDRESS', index=31, number=31,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_MAPPED_TO_UNRESERVED_ADDRESS', index=32, number=32,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_HAS_NON_ROUTABLE_IP_ADDRESS', index=33, number=33,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SEED_URL_HAS_UNRESERVED_IP_ADDRESS', index=34, number=35,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SERVICE_ACCOUNT_NOT_CONFIGURED', index=35, number=36,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOO_MANY_SCANS', index=36, number=37,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNABLE_TO_RESOLVE_PROJECT_INFO', index=37, number=38,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSUPPORTED_BLACKLIST_PATTERN_FORMAT', index=38, number=39,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSUPPORTED_FILTER', index=39, number=40,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSUPPORTED_FINDING_TYPE', index=40, number=41,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNSUPPORTED_URL_SCHEME', index=41, number=42,
      serialized_options=None,
      type=None),
  ],
...
_SCANCONFIGERROR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='google.cloud.websecurityscanner.v1beta.ScanConfigError.code', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='field_name', full_name='google.cloud.websecurityscanner.v1beta.ScanConfigError.field_name', index=1,
