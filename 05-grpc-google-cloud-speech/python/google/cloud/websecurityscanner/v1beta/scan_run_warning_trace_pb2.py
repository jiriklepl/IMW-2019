...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/websecurityscanner/v1beta/scan_run_warning_trace.proto',
...
_SCANRUNWARNINGTRACE_CODE = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INSUFFICIENT_CRAWL_RESULTS', index=1, number=1,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOO_MANY_CRAWL_RESULTS', index=2, number=2,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='TOO_MANY_FUZZ_TASKS', index=3, number=3,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BLOCKED_BY_IAP', index=4, number=4,
      serialized_options=None,
      type=None),
  ],
...
_SCANRUNWARNINGTRACE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='google.cloud.websecurityscanner.v1beta.ScanRunWarningTrace.code', index=0,
...
ScanRunWarningTrace = _reflection.GeneratedProtocolMessageType('ScanRunWarningTrace', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.websecurityscanner.v1beta.scan_run_warning_trace_pb2'
