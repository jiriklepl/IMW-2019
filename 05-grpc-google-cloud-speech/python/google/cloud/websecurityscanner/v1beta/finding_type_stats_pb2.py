...
_FINDINGTYPESTATS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='finding_type', full_name='google.cloud.websecurityscanner.v1beta.FindingTypeStats.finding_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='finding_count', full_name='google.cloud.websecurityscanner.v1beta.FindingTypeStats.finding_count', index=1,
