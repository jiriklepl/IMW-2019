...
_ANNOTATEASSESSMENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A/\n-recaptchaenterprise.googleapis.com/Assessment', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
_GETKEYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A(\n&recaptchaenterprise.googleapis.com/Key', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
