...
from google.cloud.asset.v1beta1 import assets_pb2 as google_dot_cloud_dot_asset_dot_v1beta1_dot_assets__pb2
from google.longrunning import operations_pb2 as google_dot_longrunning_dot_operations__pb2
from google.protobuf import timestamp_pb2 as google_dot_protobuf_dot_timestamp__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/asset/v1beta1/asset_service.proto',
...
_GCSDESTINATION = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='object_uri', full_name='google.cloud.asset.v1beta1.GcsDestination.object_uri',
      index=0, containing_type=None, fields=[]),
  ],
...
_BATCHGETASSETSHISTORYREQUEST.fields_by_name['read_time_window'].message_type = google_dot_cloud_dot_asset_dot_v1beta1_dot_assets__pb2._TIMEWINDOW
_BATCHGETASSETSHISTORYRESPONSE.fields_by_name['assets'].message_type = google_dot_cloud_dot_asset_dot_v1beta1_dot_assets__pb2._TEMPORALASSET
...
ExportAssetsRequest = _reflection.GeneratedProtocolMessageType('ExportAssetsRequest', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.asset.v1beta1.asset_service_pb2'
...
_ASSETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\222\001\")/v1beta1/{parent=projects/*}:exportAssets:\001*Z-\"(/v1beta1/{parent=folders/*}:exportAssets:\001*Z3\"./v1beta1/{parent=organizations/*}:exportAssets:\001*',
  ),
  _descriptor.MethodDescriptor(
