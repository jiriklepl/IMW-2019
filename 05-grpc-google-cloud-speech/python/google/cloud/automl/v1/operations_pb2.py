...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1/operations.proto',
...
_OPERATIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='delete_details', full_name='google.cloud.automl.v1.OperationMetadata.delete_details', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='deploy_model_details', full_name='google.cloud.automl.v1.OperationMetadata.deploy_model_details', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='undeploy_model_details', full_name='google.cloud.automl.v1.OperationMetadata.undeploy_model_details', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_model_details', full_name='google.cloud.automl.v1.OperationMetadata.create_model_details', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_dataset_details', full_name='google.cloud.automl.v1.OperationMetadata.create_dataset_details', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='import_data_details', full_name='google.cloud.automl.v1.OperationMetadata.import_data_details', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='batch_predict_details', full_name='google.cloud.automl.v1.OperationMetadata.batch_predict_details', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='export_data_details', full_name='google.cloud.automl.v1.OperationMetadata.export_data_details', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='export_model_details', full_name='google.cloud.automl.v1.OperationMetadata.export_model_details', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='progress_percent', full_name='google.cloud.automl.v1.OperationMetadata.progress_percent', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_failures', full_name='google.cloud.automl.v1.OperationMetadata.partial_failures', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.automl.v1.OperationMetadata.create_time', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.cloud.automl.v1.OperationMetadata.update_time', index=12,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='details', full_name='google.cloud.automl.v1.OperationMetadata.details',
...
_EXPORTDATAOPERATIONMETADATA_EXPORTDATAOUTPUTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_output_directory', full_name='google.cloud.automl.v1.ExportDataOperationMetadata.ExportDataOutputInfo.gcs_output_directory', index=0,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='output_location', full_name='google.cloud.automl.v1.ExportDataOperationMetadata.ExportDataOutputInfo.output_location',
      index=0, containing_type=None, fields=[]),
  ],
...
_EXPORTDATAOPERATIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='output_info', full_name='google.cloud.automl.v1.ExportDataOperationMetadata.output_info', index=0,
...
_BATCHPREDICTOPERATIONMETADATA_BATCHPREDICTOUTPUTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_output_directory', full_name='google.cloud.automl.v1.BatchPredictOperationMetadata.BatchPredictOutputInfo.gcs_output_directory', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='output_location', full_name='google.cloud.automl.v1.BatchPredictOperationMetadata.BatchPredictOutputInfo.output_location',
      index=0, containing_type=None, fields=[]),
  ],
...
_BATCHPREDICTOPERATIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='input_config', full_name='google.cloud.automl.v1.BatchPredictOperationMetadata.input_config', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='output_info', full_name='google.cloud.automl.v1.BatchPredictOperationMetadata.output_info', index=1,
...
_EXPORTMODELOPERATIONMETADATA_EXPORTMODELOUTPUTINFO = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='gcs_output_directory', full_name='google.cloud.automl.v1.ExportModelOperationMetadata.ExportModelOutputInfo.gcs_output_directory', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPORTMODELOPERATIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='output_info', full_name='google.cloud.automl.v1.ExportModelOperationMetadata.output_info', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OPERATIONMETADATA.fields_by_name['create_dataset_details'].message_type = _CREATEDATASETOPERATIONMETADATA
...
_OPERATIONMETADATA.fields_by_name['create_dataset_details'].containing_oneof = _OPERATIONMETADATA.oneofs_by_name['details']
_OPERATIONMETADATA.oneofs_by_name['details'].fields.append(
...
_BATCHPREDICTOPERATIONMETADATA.fields_by_name['input_config'].message_type = google_dot_cloud_dot_automl_dot_v1_dot_io__pb2._BATCHPREDICTINPUTCONFIG
