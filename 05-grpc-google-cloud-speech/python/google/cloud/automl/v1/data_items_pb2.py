...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1/data_items.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_cloud_dot_automl_dot_v1_dot_geometry__pb2.DESCRIPTOR,google_dot_cloud_dot_automl_dot_v1_dot_io__pb2.DESCRIPTOR,google_dot_cloud_dot_automl_dot_v1_dot_text__segment__pb2.DESCRIPTOR,google_dot_protobuf_dot_any__pb2.DESCRIPTOR,google_dot_protobuf_dot_duration__pb2.DESCRIPTOR,google_dot_protobuf_dot_struct__pb2.DESCRIPTOR,])
...
_IMAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='image_bytes', full_name='google.cloud.automl.v1.Image.image_bytes', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='thumbnail_uri', full_name='google.cloud.automl.v1.Image.thumbnail_uri', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='data', full_name='google.cloud.automl.v1.Image.data',
...
_TEXTSNIPPET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='content', full_name='google.cloud.automl.v1.TextSnippet.content', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mime_type', full_name='google.cloud.automl.v1.TextSnippet.mime_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='content_uri', full_name='google.cloud.automl.v1.TextSnippet.content_uri', index=2,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DOCUMENTDIMENSIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unit', full_name='google.cloud.automl.v1.DocumentDimensions.unit', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width', full_name='google.cloud.automl.v1.DocumentDimensions.width', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='google.cloud.automl.v1.DocumentDimensions.height', index=2,
...
_DOCUMENT_LAYOUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='text_segment', full_name='google.cloud.automl.v1.Document.Layout.text_segment', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_number', full_name='google.cloud.automl.v1.Document.Layout.page_number', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.automl.v1.Document.Layout.bounding_poly', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text_segment_type', full_name='google.cloud.automl.v1.Document.Layout.text_segment_type', index=3,
...
_DOCUMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='input_config', full_name='google.cloud.automl.v1.Document.input_config', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='document_text', full_name='google.cloud.automl.v1.Document.document_text', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='layout', full_name='google.cloud.automl.v1.Document.layout', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='document_dimensions', full_name='google.cloud.automl.v1.Document.document_dimensions', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_count', full_name='google.cloud.automl.v1.Document.page_count', index=4,
...
_EXAMPLEPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='image', full_name='google.cloud.automl.v1.ExamplePayload.image', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text_snippet', full_name='google.cloud.automl.v1.ExamplePayload.text_snippet', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='document', full_name='google.cloud.automl.v1.ExamplePayload.document', index=2,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='payload', full_name='google.cloud.automl.v1.ExamplePayload.payload',
      index=0, containing_type=None, fields=[]),
  ],
...
_DOCUMENT_LAYOUT.fields_by_name['text_segment'].message_type = google_dot_cloud_dot_automl_dot_v1_dot_text__segment__pb2._TEXTSEGMENT
_DOCUMENT_LAYOUT.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_automl_dot_v1_dot_geometry__pb2._BOUNDINGPOLY
...
_DOCUMENT.fields_by_name['input_config'].message_type = google_dot_cloud_dot_automl_dot_v1_dot_io__pb2._DOCUMENTINPUTCONFIG
