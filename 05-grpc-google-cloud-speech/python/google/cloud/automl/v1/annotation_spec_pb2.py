...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1/annotation_spec.proto',
...
_ANNOTATIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.automl.v1.AnnotationSpec.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.automl.v1.AnnotationSpec.display_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='example_count', full_name='google.cloud.automl.v1.AnnotationSpec.example_count', index=2,
