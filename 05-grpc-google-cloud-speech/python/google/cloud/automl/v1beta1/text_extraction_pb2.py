...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/text_extraction.proto',
  ...
  ,
  dependencies=[google_dot_cloud_dot_automl_dot_v1beta1_dot_text__segment__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_TEXTEXTRACTIONANNOTATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='text_segment', full_name='google.cloud.automl.v1beta1.TextExtractionAnnotation.text_segment', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='score', full_name='google.cloud.automl.v1beta1.TextExtractionAnnotation.score', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='annotation', full_name='google.cloud.automl.v1beta1.TextExtractionAnnotation.annotation',
...
_TEXTEXTRACTIONEVALUATIONMETRICS_CONFIDENCEMETRICSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='confidence_threshold', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.confidence_threshold', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recall', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.recall', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='precision', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.precision', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='f1_score', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry.f1_score', index=3,
...
_TEXTEXTRACTIONEVALUATIONMETRICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='au_prc', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.au_prc', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='confidence_metrics_entries', full_name='google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.confidence_metrics_entries', index=1,
...
_TEXTEXTRACTIONANNOTATION.fields_by_name['text_segment'].message_type = google_dot_cloud_dot_automl_dot_v1beta1_dot_text__segment__pb2._TEXTSEGMENT
