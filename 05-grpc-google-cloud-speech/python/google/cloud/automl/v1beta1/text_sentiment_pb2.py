...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/text_sentiment.proto',
...
_TEXTSENTIMENTANNOTATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sentiment', full_name='google.cloud.automl.v1beta1.TextSentimentAnnotation.sentiment', index=0,
...
_TEXTSENTIMENTEVALUATIONMETRICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='precision', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.precision', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='recall', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.recall', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='f1_score', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.f1_score', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mean_absolute_error', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.mean_absolute_error', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mean_squared_error', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.mean_squared_error', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='linear_kappa', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.linear_kappa', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='quadratic_kappa', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.quadratic_kappa', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='confusion_matrix', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.confusion_matrix', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='annotation_spec_id', full_name='google.cloud.automl.v1beta1.TextSentimentEvaluationMetrics.annotation_spec_id', index=8,
...
_TEXTSENTIMENTEVALUATIONMETRICS.fields_by_name['confusion_matrix'].message_type = google_dot_cloud_dot_automl_dot_v1beta1_dot_classification__pb2._CLASSIFICATIONEVALUATIONMETRICS_CONFUSIONMATRIX
