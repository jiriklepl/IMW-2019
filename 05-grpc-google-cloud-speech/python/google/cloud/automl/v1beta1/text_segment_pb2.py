...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/text_segment.proto',
...
_TEXTSEGMENT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='content', full_name='google.cloud.automl.v1beta1.TextSegment.content', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='start_offset', full_name='google.cloud.automl.v1beta1.TextSegment.start_offset', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='end_offset', full_name='google.cloud.automl.v1beta1.TextSegment.end_offset', index=2,
...
TextSegment = _reflection.GeneratedProtocolMessageType('TextSegment', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.automl.v1beta1.text_segment_pb2'
