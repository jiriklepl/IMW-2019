...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/data_types.proto',
...
_TYPECODE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STRING', index=3, number=6,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ARRAY', index=4, number=8,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STRUCT', index=5, number=9,
      serialized_options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CATEGORY', index=6, number=10,
      serialized_options=None,
      type=None),
  ],
...
_DATATYPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='list_element_type', full_name='google.cloud.automl.v1beta1.DataType.list_element_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='struct_type', full_name='google.cloud.automl.v1beta1.DataType.struct_type', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_format', full_name='google.cloud.automl.v1beta1.DataType.time_format', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type_code', full_name='google.cloud.automl.v1beta1.DataType.type_code', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='nullable', full_name='google.cloud.automl.v1beta1.DataType.nullable', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='details', full_name='google.cloud.automl.v1beta1.DataType.details',
...
_STRUCTTYPE_FIELDSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.automl.v1beta1.StructType.FieldsEntry.key', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.automl.v1beta1.StructType.FieldsEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STRUCTTYPE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='fields', full_name='google.cloud.automl.v1beta1.StructType.fields', index=0,
...
_DATATYPE.fields_by_name['list_element_type'].containing_oneof = _DATATYPE.oneofs_by_name['details']
_DATATYPE.oneofs_by_name['details'].fields.append(
  _DATATYPE.fields_by_name['struct_type'])
_DATATYPE.fields_by_name['struct_type'].containing_oneof = _DATATYPE.oneofs_by_name['details']
_DATATYPE.oneofs_by_name['details'].fields.append(
  _DATATYPE.fields_by_name['time_format'])
_DATATYPE.fields_by_name['time_format'].containing_oneof = _DATATYPE.oneofs_by_name['details']
