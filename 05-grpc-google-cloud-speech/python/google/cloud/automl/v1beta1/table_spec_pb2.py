...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/table_spec.proto',
...
_TABLESPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.automl.v1beta1.TableSpec.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='time_column_spec_id', full_name='google.cloud.automl.v1beta1.TableSpec.time_column_spec_id', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_count', full_name='google.cloud.automl.v1beta1.TableSpec.row_count', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='valid_row_count', full_name='google.cloud.automl.v1beta1.TableSpec.valid_row_count', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='column_count', full_name='google.cloud.automl.v1beta1.TableSpec.column_count', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_configs', full_name='google.cloud.automl.v1beta1.TableSpec.input_configs', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='etag', full_name='google.cloud.automl.v1beta1.TableSpec.etag', index=6,
...
_TABLESPEC.fields_by_name['input_configs'].message_type = google_dot_cloud_dot_automl_dot_v1beta1_dot_io__pb2._INPUTCONFIG
