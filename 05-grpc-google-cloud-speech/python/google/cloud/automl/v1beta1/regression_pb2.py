...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/regression.proto',
...
_REGRESSIONEVALUATIONMETRICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='root_mean_squared_error', full_name='google.cloud.automl.v1beta1.RegressionEvaluationMetrics.root_mean_squared_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='mean_absolute_error', full_name='google.cloud.automl.v1beta1.RegressionEvaluationMetrics.mean_absolute_error', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mean_absolute_percentage_error', full_name='google.cloud.automl.v1beta1.RegressionEvaluationMetrics.mean_absolute_percentage_error', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='r_squared', full_name='google.cloud.automl.v1beta1.RegressionEvaluationMetrics.r_squared', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='root_mean_squared_log_error', full_name='google.cloud.automl.v1beta1.RegressionEvaluationMetrics.root_mean_squared_log_error', index=4,
