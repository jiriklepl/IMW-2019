...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/automl/v1beta1/geometry.proto',
...
_NORMALIZEDVERTEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.automl.v1beta1.NormalizedVertex.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.automl.v1beta1.NormalizedVertex.y', index=1,
...
_BOUNDINGPOLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='normalized_vertices', full_name='google.cloud.automl.v1beta1.BoundingPoly.normalized_vertices', index=0,
