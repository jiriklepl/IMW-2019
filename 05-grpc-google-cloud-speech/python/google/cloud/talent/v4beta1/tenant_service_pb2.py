...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/talent/v4beta1/tenant_service.proto',
...
_CREATETENANTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.talent.v4beta1.CreateTenantRequest.parent', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='tenant', full_name='google.cloud.talent.v4beta1.CreateTenantRequest.tenant', index=1,
...
_GETTENANTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.talent.v4beta1.GetTenantRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATETENANTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tenant', full_name='google.cloud.talent.v4beta1.UpdateTenantRequest.tenant', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.talent.v4beta1.UpdateTenantRequest.update_mask', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETETENANTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.talent.v4beta1.DeleteTenantRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTTENANTSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.talent.v4beta1.ListTenantsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.talent.v4beta1.ListTenantsRequest.page_token', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.talent.v4beta1.ListTenantsRequest.page_size', index=2,
...
_LISTTENANTSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='tenants', full_name='google.cloud.talent.v4beta1.ListTenantsResponse.tenants', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.talent.v4beta1.ListTenantsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='google.cloud.talent.v4beta1.ListTenantsResponse.metadata', index=2,
...
_CREATETENANTREQUEST.fields_by_name['tenant'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT
_UPDATETENANTREQUEST.fields_by_name['tenant'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT
_UPDATETENANTREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTTENANTSRESPONSE.fields_by_name['tenants'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT
_LISTTENANTSRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_common__pb2._RESPONSEMETADATA
...
_TENANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT,
    serialized_options=b'\202\323\344\223\002)\"$/v4beta1/{parent=projects/*}/tenants:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='GetTenant',
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT,
    serialized_options=b'\202\323\344\223\002&\022$/v4beta1/{name=projects/*/tenants/*}',
  ),
  _descriptor.MethodDescriptor(
    name='UpdateTenant',
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_tenant__pb2._TENANT,
    serialized_options=b'\202\323\344\223\00202+/v4beta1/{tenant.name=projects/*/tenants/*}:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='DeleteTenant',
    ...
    serialized_options=b'\202\323\344\223\002&*$/v4beta1/{name=projects/*/tenants/*}',
  ),
  _descriptor.MethodDescriptor(
    name='ListTenants',
    ...
    serialized_options=b'\202\323\344\223\002&\022$/v4beta1/{parent=projects/*}/tenants',
  ),
])
