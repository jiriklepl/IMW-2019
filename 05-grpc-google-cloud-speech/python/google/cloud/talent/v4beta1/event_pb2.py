...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/talent/v4beta1/event.proto',
...
_CLIENTEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.talent.v4beta1.ClientEvent.create_time', index=2,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='job_event', full_name='google.cloud.talent.v4beta1.ClientEvent.job_event', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='profile_event', full_name='google.cloud.talent.v4beta1.ClientEvent.profile_event', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='event_notes', full_name='google.cloud.talent.v4beta1.ClientEvent.event_notes', index=5,
...
_JOBEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='profile', full_name='google.cloud.talent.v4beta1.JobEvent.profile', index=2,
...
_PROFILEEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='jobs', full_name='google.cloud.talent.v4beta1.ProfileEvent.jobs', index=2,
