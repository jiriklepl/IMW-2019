...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/talent/v4beta1/application_service.proto',
...
_CREATEAPPLICATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.talent.v4beta1.CreateApplicationRequest.parent', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='application', full_name='google.cloud.talent.v4beta1.CreateApplicationRequest.application', index=1,
...
_GETAPPLICATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.talent.v4beta1.GetApplicationRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEAPPLICATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='application', full_name='google.cloud.talent.v4beta1.UpdateApplicationRequest.application', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.talent.v4beta1.UpdateApplicationRequest.update_mask', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEAPPLICATIONREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.talent.v4beta1.DeleteApplicationRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTAPPLICATIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.talent.v4beta1.ListApplicationsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.talent.v4beta1.ListApplicationsRequest.page_token', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.talent.v4beta1.ListApplicationsRequest.page_size', index=2,
...
_LISTAPPLICATIONSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='applications', full_name='google.cloud.talent.v4beta1.ListApplicationsResponse.applications', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.talent.v4beta1.ListApplicationsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='metadata', full_name='google.cloud.talent.v4beta1.ListApplicationsResponse.metadata', index=2,
...
_CREATEAPPLICATIONREQUEST.fields_by_name['application'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION
_UPDATEAPPLICATIONREQUEST.fields_by_name['application'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION
_UPDATEAPPLICATIONREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTAPPLICATIONSRESPONSE.fields_by_name['applications'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION
_LISTAPPLICATIONSRESPONSE.fields_by_name['metadata'].message_type = google_dot_cloud_dot_talent_dot_v4beta1_dot_common__pb2._RESPONSEMETADATA
...
_APPLICATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION,
    serialized_options=b'\202\323\344\223\002C\">/v4beta1/{parent=projects/*/tenants/*/profiles/*}/applications:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='GetApplication',
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION,
    serialized_options=b'\202\323\344\223\002@\022>/v4beta1/{name=projects/*/tenants/*/profiles/*/applications/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_talent_dot_v4beta1_dot_application__pb2._APPLICATION,
    serialized_options=b'\202\323\344\223\002O2J/v4beta1/{application.name=projects/*/tenants/*/profiles/*/applications/*}:\001*',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002@*>/v4beta1/{name=projects/*/tenants/*/profiles/*/applications/*}',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002@\022>/v4beta1/{parent=projects/*/tenants/*/profiles/*}/applications',
  ),
])
