...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/datacatalog/v1beta1/search.proto',
...
_SEARCHCATALOGRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='search_result_type', full_name='google.cloud.datacatalog.v1beta1.SearchCatalogResult.search_result_type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='search_result_subtype', full_name='google.cloud.datacatalog.v1beta1.SearchCatalogResult.search_result_subtype', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='relative_resource_name', full_name='google.cloud.datacatalog.v1beta1.SearchCatalogResult.relative_resource_name', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='linked_resource', full_name='google.cloud.datacatalog.v1beta1.SearchCatalogResult.linked_resource', index=3,
