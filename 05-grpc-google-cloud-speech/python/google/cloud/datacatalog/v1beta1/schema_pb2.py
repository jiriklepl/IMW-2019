...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/datacatalog/v1beta1/schema.proto',
...
_SCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='columns', full_name='google.cloud.datacatalog.v1beta1.Schema.columns', index=0,
...
_COLUMNSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='column', full_name='google.cloud.datacatalog.v1beta1.ColumnSchema.column', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='type', full_name='google.cloud.datacatalog.v1beta1.ColumnSchema.type', index=1,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.datacatalog.v1beta1.ColumnSchema.description', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='mode', full_name='google.cloud.datacatalog.v1beta1.ColumnSchema.mode', index=3,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subcolumns', full_name='google.cloud.datacatalog.v1beta1.ColumnSchema.subcolumns', index=4,
