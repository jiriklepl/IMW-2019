...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/datacatalog/v1beta1/policytagmanagerserialization.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_datacatalog_dot_v1beta1_dot_policytagmanager__pb2.DESCRIPTOR,google_dot_iam_dot_v1_dot_policy__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,])
...
_SERIALIZEDTAXONOMY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.datacatalog.v1beta1.SerializedTaxonomy.display_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.datacatalog.v1beta1.SerializedTaxonomy.description', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='policy_tags', full_name='google.cloud.datacatalog.v1beta1.SerializedTaxonomy.policy_tags', index=2,
...
_SERIALIZEDPOLICYTAG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.datacatalog.v1beta1.SerializedPolicyTag.display_name', index=0,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.datacatalog.v1beta1.SerializedPolicyTag.description', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='child_policy_tags', full_name='google.cloud.datacatalog.v1beta1.SerializedPolicyTag.child_policy_tags', index=2,
...
_IMPORTTAXONOMIESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.datacatalog.v1beta1.ImportTaxonomiesRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='inline_source', full_name='google.cloud.datacatalog.v1beta1.ImportTaxonomiesRequest.inline_source', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='source', full_name='google.cloud.datacatalog.v1beta1.ImportTaxonomiesRequest.source',
...
_INLINESOURCE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='taxonomies', full_name='google.cloud.datacatalog.v1beta1.InlineSource.taxonomies', index=0,
...
_IMPORTTAXONOMIESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='taxonomies', full_name='google.cloud.datacatalog.v1beta1.ImportTaxonomiesResponse.taxonomies', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXPORTTAXONOMIESREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.datacatalog.v1beta1.ExportTaxonomiesRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A%\022#datacatalog.googleapis.com/Taxonomy', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='taxonomies', full_name='google.cloud.datacatalog.v1beta1.ExportTaxonomiesRequest.taxonomies', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='serialized_taxonomies', full_name='google.cloud.datacatalog.v1beta1.ExportTaxonomiesRequest.serialized_taxonomies', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='destination', full_name='google.cloud.datacatalog.v1beta1.ExportTaxonomiesRequest.destination',
      index=0, containing_type=None, fields=[]),
  ],
...
_EXPORTTAXONOMIESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='taxonomies', full_name='google.cloud.datacatalog.v1beta1.ExportTaxonomiesResponse.taxonomies', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_IMPORTTAXONOMIESRESPONSE.fields_by_name['taxonomies'].message_type = google_dot_cloud_dot_datacatalog_dot_v1beta1_dot_policytagmanager__pb2._TAXONOMY
