...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/dialogflow/v2/agent.proto',
...
_AGENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='api_version', full_name='google.cloud.dialogflow.v2.Agent.api_version', index=10,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tier', full_name='google.cloud.dialogflow.v2.Agent.tier', index=11,
...
_SETAGENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='agent', full_name='google.cloud.dialogflow.v2.SetAgentRequest.agent', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.dialogflow.v2.SetAgentRequest.update_mask', index=1,
...
_DELETEAGENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.dialogflow.v2.DeleteAgentRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
