...
from google.cloud.dataproc.v1beta2 import workflow_templates_pb2 as google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2
...
class WorkflowTemplateServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateWorkflowTemplate = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.CreateWorkflowTemplateRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.FromString,
        )
    self.GetWorkflowTemplate = channel.unary_unary(
        '/google.cloud.dataproc.v1beta2.WorkflowTemplateService/GetWorkflowTemplate',
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.GetWorkflowTemplateRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.FromString,
        )
    self.InstantiateWorkflowTemplate = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.InstantiateWorkflowTemplateRequest.SerializeToString,
    ...
    self.InstantiateInlineWorkflowTemplate = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.InstantiateInlineWorkflowTemplateRequest.SerializeToString,
        response_deserializer=google_dot_longrunning_dot_operations__pb2.Operation.FromString,
        )
    self.UpdateWorkflowTemplate = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.UpdateWorkflowTemplateRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.FromString,
        )
    self.ListWorkflowTemplates = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.ListWorkflowTemplatesRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.ListWorkflowTemplatesResponse.FromString,
        )
    self.DeleteWorkflowTemplate = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.DeleteWorkflowTemplateRequest.SerializeToString,
...
def add_WorkflowTemplateServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'CreateWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.CreateWorkflowTemplateRequest.FromString,
          response_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.SerializeToString,
      ),
      'GetWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          servicer.GetWorkflowTemplate,
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.GetWorkflowTemplateRequest.FromString,
          response_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.SerializeToString,
      ),
      'InstantiateWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          servicer.InstantiateWorkflowTemplate,
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.InstantiateWorkflowTemplateRequest.FromString,
      ...
      'InstantiateInlineWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.InstantiateInlineWorkflowTemplateRequest.FromString,
          response_serializer=google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ),
      'UpdateWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateWorkflowTemplate,
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.UpdateWorkflowTemplateRequest.FromString,
          response_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.WorkflowTemplate.SerializeToString,
      ),
      'ListWorkflowTemplates': grpc.unary_unary_rpc_method_handler(
          servicer.ListWorkflowTemplates,
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.ListWorkflowTemplatesRequest.FromString,
          response_serializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.ListWorkflowTemplatesResponse.SerializeToString,
      ),
      'DeleteWorkflowTemplate': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteWorkflowTemplate,
          request_deserializer=google_dot_cloud_dot_dataproc_dot_v1beta2_dot_workflow__templates__pb2.DeleteWorkflowTemplateRequest.FromString,
