...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/dataproc/v1beta2/operations.proto',
...
_CLUSTEROPERATIONSTATUS = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dataproc.v1beta2.ClusterOperationStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.dataproc.v1beta2.ClusterOperationStatus.state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='inner_state', full_name='google.cloud.dataproc.v1beta2.ClusterOperationStatus.inner_state', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='details', full_name='google.cloud.dataproc.v1beta2.ClusterOperationStatus.details', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state_start_time', full_name='google.cloud.dataproc.v1beta2.ClusterOperationStatus.state_start_time', index=3,
...
_CLUSTEROPERATIONMETADATA_LABELSENTRY = _descriptor.Descriptor(
  name='LabelsEntry',
  full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.LabelsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.LabelsEntry.key', index=0,
...
_CLUSTEROPERATIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='cluster_name', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cluster_uuid', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.cluster_uuid', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='status_history', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.status_history', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='operation_type', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.operation_type', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.description', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.labels', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='warnings', full_name='google.cloud.dataproc.v1beta2.ClusterOperationMetadata.warnings', index=7,
...
ClusterOperationStatus = _reflection.GeneratedProtocolMessageType('ClusterOperationStatus', (_message.Message,), {
  ...
  '__module__' : 'google.cloud.dataproc.v1beta2.operations_pb2'
