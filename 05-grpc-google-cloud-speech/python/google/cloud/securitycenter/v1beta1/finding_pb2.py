...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1beta1/finding.proto',
...
_FINDING.fields_by_name['security_marks'].message_type = google_dot_cloud_dot_securitycenter_dot_v1beta1_dot_security__marks__pb2._SECURITYMARKS
