...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1/run_asset_discovery_response.proto',
...
_RUNASSETDISCOVERYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.securitycenter.v1.RunAssetDiscoveryResponse.state', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='duration', full_name='google.cloud.securitycenter.v1.RunAssetDiscoveryResponse.duration', index=1,
...
_RUNASSETDISCOVERYRESPONSE.fields_by_name['state'].enum_type = _RUNASSETDISCOVERYRESPONSE_STATE
_RUNASSETDISCOVERYRESPONSE.fields_by_name['duration'].message_type = google_dot_protobuf_dot_duration__pb2._DURATION
_RUNASSETDISCOVERYRESPONSE_STATE.containing_type = _RUNASSETDISCOVERYRESPONSE
DESCRIPTOR.message_types_by_name['RunAssetDiscoveryResponse'] = _RUNASSETDISCOVERYRESPONSE
