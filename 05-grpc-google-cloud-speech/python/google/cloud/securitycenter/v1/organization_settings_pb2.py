...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/securitycenter/v1/organization_settings.proto',
...
_ORGANIZATIONSETTINGS_ASSETDISCOVERYCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='project_ids', full_name='google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.project_ids', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='inclusion_mode', full_name='google.cloud.securitycenter.v1.OrganizationSettings.AssetDiscoveryConfig.inclusion_mode', index=1,
...
_ORGANIZATIONSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.securitycenter.v1.OrganizationSettings.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_asset_discovery', full_name='google.cloud.securitycenter.v1.OrganizationSettings.enable_asset_discovery', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='asset_discovery_config', full_name='google.cloud.securitycenter.v1.OrganizationSettings.asset_discovery_config', index=2,
