...
_TASK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schedule_time', full_name='google.cloud.tasks.v2beta3.Task.schedule_time', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.tasks.v2beta3.Task.create_time', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dispatch_deadline', full_name='google.cloud.tasks.v2beta3.Task.dispatch_deadline', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dispatch_count', full_name='google.cloud.tasks.v2beta3.Task.dispatch_count', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='response_count', full_name='google.cloud.tasks.v2beta3.Task.response_count', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='first_attempt', full_name='google.cloud.tasks.v2beta3.Task.first_attempt', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_attempt', full_name='google.cloud.tasks.v2beta3.Task.last_attempt', index=9,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='view', full_name='google.cloud.tasks.v2beta3.Task.view', index=10,
