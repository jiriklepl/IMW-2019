...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/tasks/v2beta3/queue.proto',
...
_QUEUE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='stackdriver_logging_config', full_name='google.cloud.tasks.v2beta3.Queue.stackdriver_logging_config', index=6,
...
_STACKDRIVERLOGGINGCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='sampling_ratio', full_name='google.cloud.tasks.v2beta3.StackdriverLoggingConfig.sampling_ratio', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUEUE.fields_by_name['app_engine_http_queue'].message_type = google_dot_cloud_dot_tasks_dot_v2beta3_dot_target__pb2._APPENGINEHTTPQUEUE
...
_QUEUE.fields_by_name['stackdriver_logging_config'].message_type = _STACKDRIVERLOGGINGCONFIG
