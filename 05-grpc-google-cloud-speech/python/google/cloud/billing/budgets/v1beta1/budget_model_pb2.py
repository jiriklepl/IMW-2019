...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/billing/budgets/v1beta1/budget_model.proto',
...
_BUDGET = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.billing.budgets.v1beta1.Budget.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.billing.budgets.v1beta1.Budget.display_name', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='budget_filter', full_name='google.cloud.billing.budgets.v1beta1.Budget.budget_filter', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='amount', full_name='google.cloud.billing.budgets.v1beta1.Budget.amount', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='threshold_rules', full_name='google.cloud.billing.budgets.v1beta1.Budget.threshold_rules', index=4,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='all_updates_rule', full_name='google.cloud.billing.budgets.v1beta1.Budget.all_updates_rule', index=5,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='etag', full_name='google.cloud.billing.budgets.v1beta1.Budget.etag', index=6,
...
_BUDGETAMOUNT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='specified_amount', full_name='google.cloud.billing.budgets.v1beta1.BudgetAmount.specified_amount', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='last_period_amount', full_name='google.cloud.billing.budgets.v1beta1.BudgetAmount.last_period_amount', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='budget_amount', full_name='google.cloud.billing.budgets.v1beta1.BudgetAmount.budget_amount',
...
_THRESHOLDRULE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='threshold_percent', full_name='google.cloud.billing.budgets.v1beta1.ThresholdRule.threshold_percent', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='spend_basis', full_name='google.cloud.billing.budgets.v1beta1.ThresholdRule.spend_basis', index=1,
...
_ALLUPDATESRULE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pubsub_topic', full_name='google.cloud.billing.budgets.v1beta1.AllUpdatesRule.pubsub_topic', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema_version', full_name='google.cloud.billing.budgets.v1beta1.AllUpdatesRule.schema_version', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FILTER = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='projects', full_name='google.cloud.billing.budgets.v1beta1.Filter.projects', index=0,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='credit_types_treatment', full_name='google.cloud.billing.budgets.v1beta1.Filter.credit_types_treatment', index=1,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='services', full_name='google.cloud.billing.budgets.v1beta1.Filter.services', index=2,
...
Budget = _reflection.GeneratedProtocolMessageType('Budget', (_message.Message,), {
  'DESCRIPTOR' : _BUDGET,
  '__module__' : 'google.cloud.billing.budgets.v1beta1.budget_model_pb2'
