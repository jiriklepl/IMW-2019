...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/billing/budgets/v1beta1/budget_service.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_billing_dot_budgets_dot_v1beta1_dot_budget__model__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,])
...
_CREATEBUDGETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.billing.budgets.v1beta1.CreateBudgetRequest.parent', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='budget', full_name='google.cloud.billing.budgets.v1beta1.CreateBudgetRequest.budget', index=1,
...
_UPDATEBUDGETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='budget', full_name='google.cloud.billing.budgets.v1beta1.UpdateBudgetRequest.budget', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.billing.budgets.v1beta1.UpdateBudgetRequest.update_mask', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETBUDGETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.billing.budgets.v1beta1.GetBudgetRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTBUDGETSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.billing.budgets.v1beta1.ListBudgetsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A&\022$billingbudgets.googleapis.com/Budget', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.billing.budgets.v1beta1.ListBudgetsRequest.page_size', index=1,
      ...
      serialized_options=b'\340A\001', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.billing.budgets.v1beta1.ListBudgetsRequest.page_token', index=2,
...
_LISTBUDGETSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='budgets', full_name='google.cloud.billing.budgets.v1beta1.ListBudgetsResponse.budgets', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.billing.budgets.v1beta1.ListBudgetsResponse.next_page_token', index=1,
...
_DELETEBUDGETREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.billing.budgets.v1beta1.DeleteBudgetRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEBUDGETREQUEST.fields_by_name['budget'].message_type = google_dot_cloud_dot_billing_dot_budgets_dot_v1beta1_dot_budget__model__pb2._BUDGET
_UPDATEBUDGETREQUEST.fields_by_name['budget'].message_type = google_dot_cloud_dot_billing_dot_budgets_dot_v1beta1_dot_budget__model__pb2._BUDGET
_UPDATEBUDGETREQUEST.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_LISTBUDGETSRESPONSE.fields_by_name['budgets'].message_type = google_dot_cloud_dot_billing_dot_budgets_dot_v1beta1_dot_budget__model__pb2._BUDGET
...
_BUDGETSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_billing_dot_budgets_dot_v1beta1_dot_budget__model__pb2._BUDGET,
