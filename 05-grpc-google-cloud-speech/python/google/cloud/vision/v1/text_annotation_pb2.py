...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/vision/v1/text_annotation.proto',
...
_BLOCK.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision_dot_v1_dot_geometry__pb2._BOUNDINGPOLY
...
_PARAGRAPH.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision_dot_v1_dot_geometry__pb2._BOUNDINGPOLY
...
_WORD.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision_dot_v1_dot_geometry__pb2._BOUNDINGPOLY
...
_SYMBOL.fields_by_name['bounding_box'].message_type = google_dot_cloud_dot_vision_dot_v1_dot_geometry__pb2._BOUNDINGPOLY
