...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/vision/v1/web_detection.proto',
...
_WEBDETECTION_WEBPAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='page_title', full_name='google.cloud.vision.v1.WebDetection.WebPage.page_title', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='full_matching_images', full_name='google.cloud.vision.v1.WebDetection.WebPage.full_matching_images', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='partial_matching_images', full_name='google.cloud.vision.v1.WebDetection.WebPage.partial_matching_images', index=4,
...
_WEBDETECTION_WEBLABEL = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='label', full_name='google.cloud.vision.v1.WebDetection.WebLabel.label', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='language_code', full_name='google.cloud.vision.v1.WebDetection.WebLabel.language_code', index=1,
...
_WEBDETECTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='visually_similar_images', full_name='google.cloud.vision.v1.WebDetection.visually_similar_images', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='best_guess_labels', full_name='google.cloud.vision.v1.WebDetection.best_guess_labels', index=5,
