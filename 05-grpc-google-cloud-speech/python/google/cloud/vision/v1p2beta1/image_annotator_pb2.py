...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/vision/v1p2beta1/image_annotator.proto',
...
_FACEANNOTATION_LANDMARK.fields_by_name['position'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_geometry__pb2._POSITION
...
_FACEANNOTATION.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_geometry__pb2._BOUNDINGPOLY
_FACEANNOTATION.fields_by_name['fd_bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_geometry__pb2._BOUNDINGPOLY
...
_ENTITYANNOTATION.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_geometry__pb2._BOUNDINGPOLY
...
_CROPHINT.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_geometry__pb2._BOUNDINGPOLY
...
_ANNOTATEIMAGERESPONSE.fields_by_name['full_text_annotation'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_text__annotation__pb2._TEXTANNOTATION
...
_ANNOTATEIMAGERESPONSE.fields_by_name['web_detection'].message_type = google_dot_cloud_dot_vision_dot_v1p2beta1_dot_web__detection__pb2._WEBDETECTION
...
Feature = _reflection.GeneratedProtocolMessageType('Feature', (_message.Message,), {
  'DESCRIPTOR' : _FEATURE,
  '__module__' : 'google.cloud.vision.v1p2beta1.image_annotator_pb2'
...
_IMAGEANNOTATOR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\037\"\032/v1p2beta1/images:annotate:\001*',
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002(\"#/v1p2beta1/files:asyncBatchAnnotate:\001*',
  ),
])
