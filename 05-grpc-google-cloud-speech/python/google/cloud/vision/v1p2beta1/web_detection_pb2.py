...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/vision/v1p2beta1/web_detection.proto',
...
_WEBDETECTION_WEBENTITY = _descriptor.Descriptor(
  name='WebEntity',
  full_name='google.cloud.vision.v1p2beta1.WebDetection.WebEntity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='entity_id', full_name='google.cloud.vision.v1p2beta1.WebDetection.WebEntity.entity_id', index=0,
...
_WEBDETECTION_WEBIMAGE = _descriptor.Descriptor(
  name='WebImage',
  full_name='google.cloud.vision.v1p2beta1.WebDetection.WebImage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='google.cloud.vision.v1p2beta1.WebDetection.WebImage.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEBDETECTION_WEBPAGE = _descriptor.Descriptor(
  name='WebPage',
  full_name='google.cloud.vision.v1p2beta1.WebDetection.WebPage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='url', full_name='google.cloud.vision.v1p2beta1.WebDetection.WebPage.url', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEBDETECTION_WEBLABEL = _descriptor.Descriptor(
  name='WebLabel',
  full_name='google.cloud.vision.v1p2beta1.WebDetection.WebLabel',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='label', full_name='google.cloud.vision.v1p2beta1.WebDetection.WebLabel.label', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEBDETECTION = _descriptor.Descriptor(
  name='WebDetection',
  full_name='google.cloud.vision.v1p2beta1.WebDetection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='web_entities', full_name='google.cloud.vision.v1p2beta1.WebDetection.web_entities', index=0,
...
WebDetection = _reflection.GeneratedProtocolMessageType('WebDetection', (_message.Message,), {
  ...
  'WebEntity' : _reflection.GeneratedProtocolMessageType('WebEntity', (_message.Message,), {
    ...
    '__module__' : 'google.cloud.vision.v1p2beta1.web_detection_pb2'
    # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.WebDetection.WebEntity)
    })
  ,
  ...
  'WebImage' : _reflection.GeneratedProtocolMessageType('WebImage', (_message.Message,), {
    ...
    '__module__' : 'google.cloud.vision.v1p2beta1.web_detection_pb2'
    # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.WebDetection.WebImage)
    })
  ,
  ...
  'WebPage' : _reflection.GeneratedProtocolMessageType('WebPage', (_message.Message,), {
    ...
    '__module__' : 'google.cloud.vision.v1p2beta1.web_detection_pb2'
    # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.WebDetection.WebPage)
    })
  ,
  ...
  'WebLabel' : _reflection.GeneratedProtocolMessageType('WebLabel', (_message.Message,), {
    ...
    '__module__' : 'google.cloud.vision.v1p2beta1.web_detection_pb2'
    # @@protoc_insertion_point(class_scope:google.cloud.vision.v1p2beta1.WebDetection.WebLabel)
    })
  ,
