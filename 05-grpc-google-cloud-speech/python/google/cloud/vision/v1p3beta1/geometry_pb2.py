...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/vision/v1p3beta1/geometry.proto',
...
_VERTEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.vision.v1p3beta1.Vertex.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.vision.v1p3beta1.Vertex.y', index=1,
...
_NORMALIZEDVERTEX = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.vision.v1p3beta1.NormalizedVertex.x', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.vision.v1p3beta1.NormalizedVertex.y', index=1,
...
_BOUNDINGPOLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='vertices', full_name='google.cloud.vision.v1p3beta1.BoundingPoly.vertices', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalized_vertices', full_name='google.cloud.vision.v1p3beta1.BoundingPoly.normalized_vertices', index=1,
...
_NORMALIZEDBOUNDINGPOLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='vertices', full_name='google.cloud.vision.v1p3beta1.NormalizedBoundingPoly.vertices', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_POSITION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='google.cloud.vision.v1p3beta1.Position.x', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='y', full_name='google.cloud.vision.v1p3beta1.Position.y', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='google.cloud.vision.v1p3beta1.Position.z', index=2,
