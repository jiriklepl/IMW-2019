...
_PRODUCTSEARCHPARAMS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.vision.v1p4beta1.ProductSearchParams.bounding_poly', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='product_set', full_name='google.cloud.vision.v1p4beta1.ProductSearchParams.product_set', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='product_categories', full_name='google.cloud.vision.v1p4beta1.ProductSearchParams.product_categories', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filter', full_name='google.cloud.vision.v1p4beta1.ProductSearchParams.filter', index=3,
...
_PRODUCTSEARCHRESULTS_RESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='product', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.Result.product', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='score', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.Result.score', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='image', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.Result.image', index=2,
...
_PRODUCTSEARCHRESULTS_OBJECTANNOTATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mid', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation.mid', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='language_code', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation.language_code', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation.name', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='score', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.ObjectAnnotation.score', index=3,
...
_PRODUCTSEARCHRESULTS_GROUPEDRESULT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bounding_poly', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult.bounding_poly', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult.results', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_annotations', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.GroupedResult.object_annotations', index=2,
...
_PRODUCTSEARCHRESULTS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='index_time', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.index_time', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='results', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.results', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='product_grouped_results', full_name='google.cloud.vision.v1p4beta1.ProductSearchResults.product_grouped_results', index=2,
...
_PRODUCTSEARCHPARAMS.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p4beta1_dot_geometry__pb2._BOUNDINGPOLY
_PRODUCTSEARCHRESULTS_RESULT.fields_by_name['product'].message_type = google_dot_cloud_dot_vision_dot_v1p4beta1_dot_product__search__service__pb2._PRODUCT
...
_PRODUCTSEARCHRESULTS_GROUPEDRESULT.fields_by_name['bounding_poly'].message_type = google_dot_cloud_dot_vision_dot_v1p4beta1_dot_geometry__pb2._BOUNDINGPOLY
