  ...
  * [SecretVersion][google.cloud.secrets.v1beta1.SecretVersion]
  ...
  def __init__(self, channel):
    ...
    self.ListSecrets = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretsRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretsResponse.FromString,
        )
    self.CreateSecret = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/CreateSecret',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.CreateSecretRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.FromString,
        )
    self.AddSecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/AddSecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AddSecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.FromString,
        )
    self.GetSecret = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/GetSecret',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.GetSecretRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.FromString,
        )
    self.UpdateSecret = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/UpdateSecret',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.UpdateSecretRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.FromString,
        )
    self.DeleteSecret = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/DeleteSecret',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DeleteSecretRequest.SerializeToString,
    ...
    self.ListSecretVersions = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretVersionsRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretVersionsResponse.FromString,
        )
    self.GetSecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/GetSecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.GetSecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.FromString,
        )
    self.AccessSecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/AccessSecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AccessSecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AccessSecretVersionResponse.FromString,
        )
    self.DisableSecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/DisableSecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DisableSecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.FromString,
        )
    self.EnableSecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/EnableSecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.EnableSecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.FromString,
        )
    self.DestroySecretVersion = channel.unary_unary(
        '/google.cloud.secrets.v1beta1.SecretManagerService/DestroySecretVersion',
        request_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DestroySecretVersionRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.FromString,
        )
...
def add_SecretManagerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ListSecrets': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretsRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretsResponse.SerializeToString,
      ),
      'CreateSecret': grpc.unary_unary_rpc_method_handler(
          servicer.CreateSecret,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.CreateSecretRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.SerializeToString,
      ),
      'AddSecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.AddSecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AddSecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.SerializeToString,
      ),
      'GetSecret': grpc.unary_unary_rpc_method_handler(
          servicer.GetSecret,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.GetSecretRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.SerializeToString,
      ),
      'UpdateSecret': grpc.unary_unary_rpc_method_handler(
          servicer.UpdateSecret,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.UpdateSecretRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.Secret.SerializeToString,
      ),
      'DeleteSecret': grpc.unary_unary_rpc_method_handler(
          servicer.DeleteSecret,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DeleteSecretRequest.FromString,
      ...
      'ListSecretVersions': grpc.unary_unary_rpc_method_handler(
          ...
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.ListSecretVersionsResponse.SerializeToString,
      ),
      'GetSecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.GetSecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.GetSecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.SerializeToString,
      ),
      'AccessSecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.AccessSecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AccessSecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.AccessSecretVersionResponse.SerializeToString,
      ),
      'DisableSecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.DisableSecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DisableSecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.SerializeToString,
      ),
      'EnableSecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.EnableSecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.EnableSecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.SerializeToString,
      ),
      'DestroySecretVersion': grpc.unary_unary_rpc_method_handler(
          servicer.DestroySecretVersion,
          request_deserializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_service__pb2.DestroySecretVersionRequest.FromString,
          response_serializer=google_dot_cloud_dot_secrets_dot_v1beta1_dot_resources__pb2.SecretVersion.SerializeToString,
      ),
