...
from google.cloud.phishingprotection.v1beta1 import phishingprotection_pb2 as google_dot_cloud_dot_phishingprotection_dot_v1beta1_dot_phishingprotection__pb2
...
class PhishingProtectionServiceV1Beta1Stub(object):
  ...
  def __init__(self, channel):
    ...
    self.ReportPhishing = channel.unary_unary(
        ...
        request_serializer=google_dot_cloud_dot_phishingprotection_dot_v1beta1_dot_phishingprotection__pb2.ReportPhishingRequest.SerializeToString,
        response_deserializer=google_dot_cloud_dot_phishingprotection_dot_v1beta1_dot_phishingprotection__pb2.ReportPhishingResponse.FromString,
        )
...
def add_PhishingProtectionServiceV1Beta1Servicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ReportPhishing': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=google_dot_cloud_dot_phishingprotection_dot_v1beta1_dot_phishingprotection__pb2.ReportPhishingRequest.FromString,
          response_serializer=google_dot_cloud_dot_phishingprotection_dot_v1beta1_dot_phishingprotection__pb2.ReportPhishingResponse.SerializeToString,
      ),
  }
  generic_handler = grpc.method_handlers_generic_handler(
      'google.cloud.phishingprotection.v1beta1.PhishingProtectionServiceV1Beta1', rpc_method_handlers)
