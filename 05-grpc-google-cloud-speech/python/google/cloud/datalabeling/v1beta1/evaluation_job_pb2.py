...
_EVALUATIONJOBCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='video_classification_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.video_classification_config', index=2,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_detection_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.object_detection_config', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='text_classification_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.text_classification_config', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='object_tracking_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.object_tracking_config', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='input_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.input_config', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='evaluation_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.evaluation_config', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='human_annotation_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.human_annotation_config', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bigquery_import_keys', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.bigquery_import_keys', index=9,
      number=9, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='example_count', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.example_count', index=10,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='example_sample_percentage', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.example_sample_percentage', index=11,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='evaluation_job_alert_config', full_name='google.cloud.datalabeling.v1beta1.EvaluationJobConfig.evaluation_job_alert_config', index=12,
...
_EVALUATIONJOBCONFIG.fields_by_name['video_classification_config'].message_type = google_dot_cloud_dot_datalabeling_dot_v1beta1_dot_human__annotation__config__pb2._VIDEOCLASSIFICATIONCONFIG
_EVALUATIONJOBCONFIG.fields_by_name['object_detection_config'].message_type = google_dot_cloud_dot_datalabeling_dot_v1beta1_dot_human__annotation__config__pb2._OBJECTDETECTIONCONFIG
...
_EVALUATIONJOBCONFIG.fields_by_name['object_tracking_config'].message_type = google_dot_cloud_dot_datalabeling_dot_v1beta1_dot_human__annotation__config__pb2._OBJECTTRACKINGCONFIG
...
_EVALUATIONJOBCONFIG.fields_by_name['video_classification_config'].containing_oneof = _EVALUATIONJOBCONFIG.oneofs_by_name['human_annotation_request_config']
_EVALUATIONJOBCONFIG.oneofs_by_name['human_annotation_request_config'].fields.append(
  _EVALUATIONJOBCONFIG.fields_by_name['object_detection_config'])
_EVALUATIONJOBCONFIG.fields_by_name['object_detection_config'].containing_oneof = _EVALUATIONJOBCONFIG.oneofs_by_name['human_annotation_request_config']
_EVALUATIONJOBCONFIG.oneofs_by_name['human_annotation_request_config'].fields.append(
...
_EVALUATIONJOBCONFIG.fields_by_name['object_tracking_config'].containing_oneof = _EVALUATIONJOBCONFIG.oneofs_by_name['human_annotation_request_config']
