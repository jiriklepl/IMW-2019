...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/scheduler/v1beta1/job.proto',
...
_JOB.fields_by_name['pubsub_target'].message_type = google_dot_cloud_dot_scheduler_dot_v1beta1_dot_target__pb2._PUBSUBTARGET
_JOB.fields_by_name['app_engine_http_target'].message_type = google_dot_cloud_dot_scheduler_dot_v1beta1_dot_target__pb2._APPENGINEHTTPTARGET
_JOB.fields_by_name['http_target'].message_type = google_dot_cloud_dot_scheduler_dot_v1beta1_dot_target__pb2._HTTPTARGET
