...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/scheduler/v1/cloudscheduler.proto',
  ...
  ,
  dependencies=[google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2.DESCRIPTOR,google_dot_protobuf_dot_empty__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,])
...
_LISTJOBSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.scheduler.v1.ListJobsRequest.parent', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.scheduler.v1.ListJobsRequest.page_size', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.scheduler.v1.ListJobsRequest.page_token', index=2,
...
_LISTJOBSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='jobs', full_name='google.cloud.scheduler.v1.ListJobsResponse.jobs', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.scheduler.v1.ListJobsResponse.next_page_token', index=1,
...
_GETJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.scheduler.v1.GetJobRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.scheduler.v1.CreateJobRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\340A\002\372A#\022!cloudscheduler.googleapis.com/Job', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='job', full_name='google.cloud.scheduler.v1.CreateJobRequest.job', index=1,
...
_UPDATEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='job', full_name='google.cloud.scheduler.v1.UpdateJobRequest.job', index=0,
      ...
      serialized_options=b'\340A\002', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.cloud.scheduler.v1.UpdateJobRequest.update_mask', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DELETEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.scheduler.v1.DeleteJobRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_PAUSEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.scheduler.v1.PauseJobRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RESUMEJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.scheduler.v1.ResumeJobRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_RUNJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.scheduler.v1.RunJobRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTJOBSRESPONSE.fields_by_name['jobs'].message_type = google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB
_CREATEJOBREQUEST.fields_by_name['job'].message_type = google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB
_UPDATEJOBREQUEST.fields_by_name['job'].message_type = google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB
...
_CLOUDSCHEDULER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB,
