...
_ENTITYRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='version', full_name='google.datastore.v1beta3.EntityResult.version', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cursor', full_name='google.datastore.v1beta3.EntityResult.cursor', index=2,
...
_QUERYRESULTBATCH = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='snapshot_version', full_name='google.datastore.v1beta3.QueryResultBatch.snapshot_version', index=6,
