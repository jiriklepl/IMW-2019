...
_DATASTOREADMIN = _descriptor.ServiceDescriptor(
  name='DatastoreAdmin',
  full_name='google.datastore.admin.v1beta1.DatastoreAdmin',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='ExportEntities',
    full_name='google.datastore.admin.v1beta1.DatastoreAdmin.ExportEntities',
    index=0,
    containing_service=None,
    input_type=_EXPORTENTITIESREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002*\"%/v1beta1/projects/{project_id}:export:\001*',
  ),
  _descriptor.MethodDescriptor(
    name='ImportEntities',
    full_name='google.datastore.admin.v1beta1.DatastoreAdmin.ImportEntities',
    index=1,
    containing_service=None,
    input_type=_IMPORTENTITIESREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    serialized_options=b'\202\323\344\223\002*\"%/v1beta1/projects/{project_id}:import:\001*',
  ),
])
