...
_V2OPERATIONMETADATA = _descriptor.Descriptor(
  name='V2OperationMetadata',
  full_name='google.bigtable.admin.cluster.v1.V2OperationMetadata',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
DESCRIPTOR.message_types_by_name['V2OperationMetadata'] = _V2OPERATIONMETADATA
...
UndeleteClusterRequest = _reflection.GeneratedProtocolMessageType('UndeleteClusterRequest', (_message.Message,), {
...
UndeleteClusterMetadata = _reflection.GeneratedProtocolMessageType('UndeleteClusterMetadata', (_message.Message,), {
...
V2OperationMetadata = _reflection.GeneratedProtocolMessageType('V2OperationMetadata', (_message.Message,), {
  'DESCRIPTOR' : _V2OPERATIONMETADATA,
  '__module__' : 'google.bigtable.admin.cluster.v1.bigtable_cluster_service_messages_pb2'
  # @@protoc_insertion_point(class_scope:google.bigtable.admin.cluster.v1.V2OperationMetadata)
  })
_sym_db.RegisterMessage(V2OperationMetadata)
