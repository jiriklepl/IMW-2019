...
_BULKDELETEROWSREQUEST = _descriptor.Descriptor(
  name='BulkDeleteRowsRequest',
  full_name='google.bigtable.admin.table.v1.BulkDeleteRowsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='table_name', full_name='google.bigtable.admin.table.v1.BulkDeleteRowsRequest.table_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_key_prefix', full_name='google.bigtable.admin.table.v1.BulkDeleteRowsRequest.row_key_prefix', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delete_all_data_from_table', full_name='google.bigtable.admin.table.v1.BulkDeleteRowsRequest.delete_all_data_from_table', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='target', full_name='google.bigtable.admin.table.v1.BulkDeleteRowsRequest.target',
...
_BULKDELETEROWSREQUEST.oneofs_by_name['target'].fields.append(
  _BULKDELETEROWSREQUEST.fields_by_name['row_key_prefix'])
_BULKDELETEROWSREQUEST.fields_by_name['row_key_prefix'].containing_oneof = _BULKDELETEROWSREQUEST.oneofs_by_name['target']
_BULKDELETEROWSREQUEST.oneofs_by_name['target'].fields.append(
  _BULKDELETEROWSREQUEST.fields_by_name['delete_all_data_from_table'])
_BULKDELETEROWSREQUEST.fields_by_name['delete_all_data_from_table'].containing_oneof = _BULKDELETEROWSREQUEST.oneofs_by_name['target']
...
DESCRIPTOR.message_types_by_name['BulkDeleteRowsRequest'] = _BULKDELETEROWSREQUEST
...
RenameTableRequest = _reflection.GeneratedProtocolMessageType('RenameTableRequest', (_message.Message,), {
...
CreateColumnFamilyRequest = _reflection.GeneratedProtocolMessageType('CreateColumnFamilyRequest', (_message.Message,), {
...
DeleteColumnFamilyRequest = _reflection.GeneratedProtocolMessageType('DeleteColumnFamilyRequest', (_message.Message,), {
...
BulkDeleteRowsRequest = _reflection.GeneratedProtocolMessageType('BulkDeleteRowsRequest', (_message.Message,), {
  'DESCRIPTOR' : _BULKDELETEROWSREQUEST,
  '__module__' : 'google.bigtable.admin.table.v1.bigtable_table_service_messages_pb2'
  # @@protoc_insertion_point(class_scope:google.bigtable.admin.table.v1.BulkDeleteRowsRequest)
  })
_sym_db.RegisterMessage(BulkDeleteRowsRequest)
