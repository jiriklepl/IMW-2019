...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/spanner/v1/mutation.proto',
...
_MUTATION_DELETE.fields_by_name['key_set'].message_type = google_dot_spanner_dot_v1_dot_keys__pb2._KEYSET
