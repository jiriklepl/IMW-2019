...
_STRUCTUREDQUERY_FIELDFILTER_OPERATOR = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ARRAY_CONTAINS_ANY', index=8, number=9,
      serialized_options=None,
      type=None),
  ],
  containing_type=None,
