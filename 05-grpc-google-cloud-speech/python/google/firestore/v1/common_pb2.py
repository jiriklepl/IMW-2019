...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/firestore/v1/common.proto',
...
_DOCUMENTMASK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='field_paths', full_name='google.firestore.v1.DocumentMask.field_paths', index=0,
...
_PRECONDITION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='exists', full_name='google.firestore.v1.Precondition.exists', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.firestore.v1.Precondition.update_time', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='condition_type', full_name='google.firestore.v1.Precondition.condition_type',
...
_TRANSACTIONOPTIONS_READWRITE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='retry_transaction', full_name='google.firestore.v1.TransactionOptions.ReadWrite.retry_transaction', index=0,
...
_TRANSACTIONOPTIONS_READONLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='read_time', full_name='google.firestore.v1.TransactionOptions.ReadOnly.read_time', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='consistency_selector', full_name='google.firestore.v1.TransactionOptions.ReadOnly.consistency_selector',
      index=0, containing_type=None, fields=[]),
  ],
...
_TRANSACTIONOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='read_only', full_name='google.firestore.v1.TransactionOptions.read_only', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='read_write', full_name='google.firestore.v1.TransactionOptions.read_write', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='mode', full_name='google.firestore.v1.TransactionOptions.mode',
      index=0, containing_type=None, fields=[]),
  ],
