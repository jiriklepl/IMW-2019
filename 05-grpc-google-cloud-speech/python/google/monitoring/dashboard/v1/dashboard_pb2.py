...
_DASHBOARD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='row_layout', full_name='google.monitoring.dashboard.v1.Dashboard.row_layout', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='column_layout', full_name='google.monitoring.dashboard.v1.Dashboard.column_layout', index=5,
