...
_SERVICE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='telemetry', full_name='google.monitoring.v3.Service.telemetry', index=6,
  ...
  nested_types=[_SERVICE_CUSTOM, _SERVICE_APPENGINE, _SERVICE_CLOUDENDPOINTS, _SERVICE_CLUSTERISTIO, _SERVICE_TELEMETRY, ],
  enum_types=[
  ],
  serialized_options=None,
  is_extendable=False,
