...
class ProfilerServiceStub(object):
  ...
  * Profiles can be created in either online or offline mode, see below.
  ...
  def __init__(self, channel):
    ...
    self.CreateOfflineProfile = channel.unary_unary(
        '/google.devtools.cloudprofiler.v2.ProfilerService/CreateOfflineProfile',
        request_serializer=google_dot_devtools_dot_cloudprofiler_dot_v2_dot_profiler__pb2.CreateOfflineProfileRequest.SerializeToString,
        response_deserializer=google_dot_devtools_dot_cloudprofiler_dot_v2_dot_profiler__pb2.Profile.FromString,
        )
...
class ProfilerServiceServicer(object):
  ...
  * Profiles can be created in either online or offline mode, see below.
  ...
  def CreateOfflineProfile(self, request, context):
...
def add_ProfilerServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'CreateOfflineProfile': grpc.unary_unary_rpc_method_handler(
          servicer.CreateOfflineProfile,
          request_deserializer=google_dot_devtools_dot_cloudprofiler_dot_v2_dot_profiler__pb2.CreateOfflineProfileRequest.FromString,
          response_serializer=google_dot_devtools_dot_cloudprofiler_dot_v2_dot_profiler__pb2.Profile.SerializeToString,
      ),
